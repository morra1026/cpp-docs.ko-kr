...
*ext*<br/>
앞에 마침표(.)가 있거나 없는 실제 파일 확장명을 포함합니다. **_makepath** 에 나타나지 않으면 기간에 자동으로 삽입 *ext*합니다. 하는 경우 *ext* 됩니다 **NULL** 또는 빈 문자열인 경우 확장명이 없는 가리키는 복합에 삽입 됩니다 *경로* 문자열입니다.
