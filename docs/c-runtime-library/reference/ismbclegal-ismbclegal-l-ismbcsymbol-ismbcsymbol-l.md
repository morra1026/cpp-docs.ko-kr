...
|-------------|--------------------|---------------------------|
|**_ismbclegal**|유효한 멀티바이트|첫째 바이트가 0이 아닌 경우 및 경우에만 반환 *c* 이 범위를 벗어나지 0x81 – 0x9F 또는 0xE0 – 0xFC 두 번째 바이트는 0x40-0x7E 또는 0x80-범위 FC 합니다.|
|**_ismbcsymbol**|멀티바이트 기호|경우에만 0이 아닌 경우 반환 0x8141 < =*c*< 0x81AC =.|
