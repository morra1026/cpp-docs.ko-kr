# [CRT 사전순 함수 참조](crt-alphabetical-function-reference.md)
## [abort](abort.md)
...
## [_ASSERT, _ASSERTE, _ASSERT_EXPR 매크로](assert-asserte-assert-expr-macros.md)
...
## [Bessel 함수: _j0, _j1, _jn, _y0, _y1, _yn](bessel-functions-j0-j1-jn-y0-y1-yn.md)
## [bitand](bitand.md)
## [bitor](bitor.md)
## [bsearch](bsearch.md)
...
## [부동 소수점 기본 형식](floating-point-primitives.md)
...
## [not](not.md)
## [not_eq](not-eq.md)
## [offsetof 매크로](offsetof-macro.md)
...
## [_RPT, _RPTF, _RPTW, _RPTFW 매크로](rpt-rptf-rptw-rptfw-macros.md)
...
## [_STATIC_ASSERT 매크로](static-assert-macro.md)
