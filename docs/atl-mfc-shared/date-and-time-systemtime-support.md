...
SYSTEMTIME 구조체에 대 한 정보를 참조 하세요 [SYSTEMTIME](/windows/desktop/api/minwinbase/ns-minwinbase-systemtime)합니다. FILETIME 구조체에 대 한 정보를 참조 하세요 [FILETIME](/windows/desktop/api/minwinbase/ns-minwinbase-filetime)합니다.
