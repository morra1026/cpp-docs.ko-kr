...
ms.locfileid: "57421465"
---
# <a name="y-precompiled-headers"></a>/Y(미리 컴파일된 헤더)

다음 컴파일러 옵션을 생성 및 미리 컴파일된 헤더 사용에 영향을 줍니다.
...
미리 컴파일된 헤더를 사용 하 여 작업에 대 한 내용은 참조 하세요 [미리 컴파일된 헤더 파일 만들기](../../build/reference/creating-precompiled-header-files.md)합니다.
