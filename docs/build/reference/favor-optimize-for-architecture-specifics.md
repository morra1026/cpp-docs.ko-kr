---
title: -선호 (아키텍처에 대 한 최적화) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
>  Intel64 아키텍처 기술인, 이전의 되었습니다 및 해당 컴파일러 옵션은 **/favor:EM64T**합니다.  
 ...
 X64에 대 한 프로그래밍 하는 방법에 대 한 정보에 대 한 아키텍처를 참조 하세요 [x64 소프트웨어 규칙](../../build/x64-software-conventions.md)합니다.  
