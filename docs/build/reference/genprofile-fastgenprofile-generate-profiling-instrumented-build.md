...
1. 입력 된 **/GENPROFILE** 또는 **/FASTGENPROFILE** 옵션 및 인수에는 **추가 옵션** 상자입니다. 선택할 **확인** 변경 내용을 저장 합니다.
