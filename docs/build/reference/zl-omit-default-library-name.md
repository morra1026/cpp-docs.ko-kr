...
기본 라이브러리에 대 한 자세한 내용은 참조 하세요. [런타임 라이브러리 사용](../../build/reference/md-mt-ld-use-run-time-library.md)합니다.
...
사용 하 여 [/NODEFAULTLIB (라이브러리 무시)](../../build/reference/nodefaultlib-ignore-libraries.md)합니다. 링커가 모든.obj 파일의 라이브러리 참조를 무시 하도록 지시 합니다.
