...
ms.locfileid: "57422523"
---
# <a name="fs-force-synchronous-pdb-writes"></a>/F(동기 PDB 쓰기 적용)

프로그램 데이터베이스 (PDB) 파일에 강제로 쓰기-만든 [/Zi](../../build/reference/z7-zi-zi-debug-information-format.md) 하거나 [/ZI](../../build/reference/z7-zi-zi-debug-information-format.md)-MSPDBSRV 통해 직렬화 해야 합니다. EXE 수 있습니다.
...
합니다 [/MP](../../build/reference/mp-build-with-multiple-processes.md) 옵션을 사용 하면 **/FS** 기본적으로 합니다.
