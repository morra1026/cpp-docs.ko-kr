---
title: -w,-W0,-W1,-W2,-W3,-W4,-w1,-w2,-w3,-w4,-Wall,-wd,-we,-wo,-Wv,-WX (경고 수준) | Microsoft Docs
ms.custom: ''
ms.date: 01/31/2018
ms.technology:
- cpp-tools
...
|**/WX**|모든 컴파일러 경고를 오류로 처리합니다. 새 프로젝트를 사용 하 여 수 있습니다 **/WX** 모든 컴파일에서; 가장 적은 수 찾기 어려운 코드 오류를 통해 모든 경고를 해결 합니다.<br /><br /> 링커에 **/WX** 옵션입니다. 자세한 내용은 [/WX(링커 경고를 오류로 처리)](../../build/reference/wx-treat-linker-warnings-as-errors.md)를 참조하세요.|
...
사용 하는 경우 경고 옵션 중 하나를 사용 하 여 미리 컴파일된 헤더를 만들면 합니다 [/Yc](../../build/reference/yc-create-precompiled-header-file.md) 옵션을 사용 하 여 미리 컴파일된 헤더를 사용 합니다 [/Yu](../../build/reference/yu-use-precompiled-header-file.md) 옵션을 적용 하려면 이러한 동일한 경고 옵션을 사용 하면 다시 실행 합니다. 명령줄에서 다른 경고 옵션을 사용 하 여 미리 컴파일된 헤더에 설정 된 경고 옵션을 재정의할 수 있습니다.
