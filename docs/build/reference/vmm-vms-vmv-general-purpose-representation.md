...
ms.locfileid: "50578440"
---
# <a name="vmm-vms-vmv-general-purpose-representation"></a>/vmm, /vms, /vmv(일반적인 용도 표시)

때 사용 되는 [/vmb, /vmg (표시 메서드)](../../build/reference/vmb-vmg-representation-method.md) 를 선택 합니다 [표현 메서드](../../build/reference/vmb-vmg-representation-method.md)합니다. 이러한 옵션 아직 발생 하지 않은 클래스 정의의 상속 모델을 표시 합니다.
