...
부동 소수점 값의 이진 표현을 전체 자릿수와 부동 소수점 계산의 정확도 영향을 줍니다. Microsoft Visual c + +를 사용 하 여 [IEEE 부동 소수점 형식](../../build/reference/ieee-floating-point-representation.md)합니다.
