...
1. 왼쪽된 창에는 **새 프로젝트** 대화 상자에서 **Win32** 아래에 있는 **설치 됨** > **템플릿**  >  **Visual c + +** 합니다. 가운데 창에서 **Win32 콘솔 응용 프로그램**을 선택합니다. 프로젝트의 이름을 지정 `MathClient`를 **이름을** 편집 상자입니다.
