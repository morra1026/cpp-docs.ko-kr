...
|정렬된 연관 컨테이너| [\<map>](../standard-library/map.md), [\<set>](../standard-library/set.md)|
|순서가 지정되지 않는 연관 컨테이너|[<unordered_map>](../standard-library/unordered-map.md), [<unordered_set>](../standard-library/unordered-set.md)|
...
|수치연산 및 숫자|[\<complex>](../standard-library/complex.md), [\<limits>](../standard-library/limits.md), [\<numeric>](../standard-library/numeric.md), [\<random>](../standard-library/random.md), [\<ratio>](../standard-library/ratio.md), [\<valarray>](../standard-library/valarray.md)|
