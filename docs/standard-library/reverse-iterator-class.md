...
*해제* reverse_iterator에서 뺄 오프셋입니다.
...
*Off* 뺄 오프셋을 `reverse_iterator`입니다.
...
*Off* 오프셋을 `reverse_iterator` 주소입니다.
...
*오른쪽* 적용할 수에 있는 반복기를 `reverse_iterator`입니다.
