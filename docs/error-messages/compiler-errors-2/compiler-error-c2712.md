...
로 컴파일하는 경우에 C2712 발생할 수 있습니다 **/clr: pure** 의 함수 포인터의 정적 배열을 선언 하는 `__try` 블록. 정적 멤버 아래에서 동적 초기화를 사용 하도록 컴파일러에 필요한 **/clr: pure**, c + + 예외 처리를 의미 하는 합니다. 그러나 C++ 예외 처리는 `__try` 블록에서 허용되지 않습니다.
