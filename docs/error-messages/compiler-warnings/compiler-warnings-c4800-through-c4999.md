...
|컴파일러 경고 (수준 4) C4962|'*function*': 최적화 프로필 데이터가 일관성이 없는 상태가 발생 하므로 사용 하지 않도록 설정 하는 프로필 기반 최적화|
...
|[컴파일러 경고 (수준 2) C5046](c5046.md)|'*함수*'. 관련 된 형식이 정의 되지 않은 내부 링크가 있는 기호|
