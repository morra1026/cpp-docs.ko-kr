...
이 경고 Visual c + + 컴파일러 버전 18.00 Visual Studio 2015에서 새로 웠 습니다. 컴파일러 또는 코드를 마이그레이션하는 동안 나중에 해당 버전에서 발생 한 경고를 표시 하지 않으려면 사용 합니다 [/wv:18](../../build/reference/compiler-option-warning-level.md) 컴파일러 옵션입니다.
