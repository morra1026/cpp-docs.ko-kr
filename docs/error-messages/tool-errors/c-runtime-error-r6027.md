 ...
 **프로그래머에 대 한 정보**  
 ...
 이 오류는 C 런타임에서 하위 수준 I/O 지원을 초기화할 수 있도록 충분 한 여유 메모리가 없을 때 발생 합니다. 이 오류는 일반적으로 앱을 시작할 때 발생 합니다. 응용 프로그램 및 드라이버 및 dll을 로드 하는 시작 시 힙 손상 되지 않도록 확인 합니다.