...
-   열 4, 5 각 클래스의 성능에 설명 합니다. 컬렉션에 항목을 많이 삽입해야 하는 응용 프로그램에서는 삽입 속도가 특히 중요합니다. 다른 응용 프로그램에서는 조회 속도가 더 중요할 수도 있습니다.  
...
## <a name="comments"></a>설명  
 ...
 ![컬렉션 클래스에 대 한 특성 계층](../atl/media/vctraitscollectionclasseshierarchy.gif "vctraitscollectionclasseshierarchy")  
