...
[CRT에 링크하는 데 사용되는 방법의 장단점](../atl/benefits-and-tradeoffs-of-the-method-used-to-link-to-the-crt.md)  
장점 및 단점 CRT에 정적으로 연결 하거나 동적으로 연결 하는 데 참여할된 요약 되어 있습니다.

[ATL 프로젝트에서 CRT에 링크](../atl/linking-to-the-crt-in-your-atl-project.md)  
프로젝트 설정 및 CRT;에 연결 하는 것에 대 한 링커 옵션에 설명 또한 CRT에 연결 하 여 프로그램 이미지에 미치는 영향에 세부 정보를 제공 합니다.
...
VCRuntime 및 CRT 시작 코드의 작동 원리에 세부 정보를 제공 합니다.
