...
1. **솔루션 탐색기**, Polygon 프로젝트를 마우스 오른쪽 단추로 클릭 합니다.

2. 가리킨 **추가** 바로 가기 메뉴를 클릭 **새 항목** 하위 메뉴에 있습니다.
...
ATL 컨트롤 마법사 **이름을** 페이지에는 다음 필드가 포함 됩니다.
...
3. 이 컨트롤에 대 한 옵션을 완료합니다. **마침**을 클릭합니다.
...
1. **빌드** 메뉴의 **빌드 다각형**을 클릭합니다.
     ...
     컨트롤 빌드를 완료한 후에 **솔루션 탐색기**에서 PolyCtl.htm을 마우스 오른쪽 단추로 클릭하여 **브라우저에서 보기**를 선택합니다. 컨트롤을 포함하는 HTML 웹 페이지가 표시됩니다. "PolyCtl 개체에 대한 ATL 8.0 테스트 페이지" 제목 페이지와 **PolyCtl** 텍스트가 표시되어야 합니다. 보고 있는 것이 만들어진 컨트롤입니다. 사용자의 컨트롤입니다.
