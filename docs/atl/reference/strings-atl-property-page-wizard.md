---
title: ATL 속성 페이지 마법사, 문자열 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ms.locfileid: "43753752"
---
# <a name="strings-atl-property-page-wizard"></a>문자열, ATL 속성 페이지 마법사

속성 페이지를 사용 하 여 연결 된 텍스트를 제공 합니다.

**제목**  
속성 페이지의 탭에 나타나는 텍스트를 설정 합니다.

**문서 문자열**  
페이지를 설명 하는 텍스트 문자열을 설정 합니다. 이 문자열은 속성 시트 대화 상자에서 표시할 수 있습니다. 속성 프레임이 상태 줄 또는 도구 설명에 설명을 사용할 수 있습니다. 현재 표준 속성 프레임이이 문자열을 사용 하지 않습니다.
