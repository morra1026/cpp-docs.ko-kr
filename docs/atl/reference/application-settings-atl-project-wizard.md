...
- **구성 요소 등록자 지원** COM + 1.0 구성 요소에 대 한 지원을 포함 하는 ATL 프로젝트, 경우에이 옵션을 설정할 수 있습니다. 구성 요소 관리자에는 COM + 1.0 개체를 구성 요소 목록을 가져오려면, 구성 요소를 등록 하거나 (개별적으로 또는 한 번에 모두) 구성 요소 등록을 취소할 수 있습니다.
