...
자세한 내용은 [파일 매핑](/windows/desktop/Memory/file-mapping) Windows SDK에 있습니다.
...
`MapShareMem` 만든 기존 파일 매핑 개체를 사용 하면 [CreateFileMapping](/windows/desktop/api/winbase/nf-winbase-createfilemappinga)를 프로세스 간에 공유할 수 있습니다.
