...
1.  **솔루션 탐색기** 또는 [클래스 뷰](https://msdn.microsoft.com/8d7430a9-3e33-454c-a9e1-a85e3d2db925)에서 ActiveX 컨트롤 클래스를 추가할 프로젝트의 이름을 마우스 오른쪽 단추로 클릭합니다.  
