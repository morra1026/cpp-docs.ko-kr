...
```  
 ...
 Visual C++에서는 프로젝트에 정의된 [COM 인터페이스 편집](../ide/editing-a-com-interface.md) 및 확인을 위한 몇 가지 방법을 제공합니다. [클래스 뷰](/visualstudio/ide/viewing-the-structure-of-code)는 C++ 프로젝트의 .idl 파일에 정의된 모든 인터페이스 또는 dispinterface 아이콘을 표시합니다.  
