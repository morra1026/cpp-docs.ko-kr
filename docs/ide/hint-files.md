...
![강조 표시된 매크로](../ide/media/hint-squiggle-and-actions.png "힌트 오류 표시선 및 빠른 작업")
...
![건너뛴 검색 영역의 매크로 옵션](../ide/media/skipped-regions-squiggle-option.png "건너뛴 영역 오류 표시선 옵션")
