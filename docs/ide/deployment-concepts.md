...
설치 프로젝트를 솔루션에 추가하여 애플리케이션 패키지하고, 빌드할 때 사용자에게 배포하는 설정 및 설치 관리자 패키지 파일을 만듭니다. 자세한 내용은 [배포 방법 선택](../ide/choosing-a-deployment-method.md)을 참조하세요.
...
- [Visual C++ 애플리케이션의 종속성 이해](../ide/understanding-the-dependencies-of-a-visual-cpp-application.md)
