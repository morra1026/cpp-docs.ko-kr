...
[폼 기반 MFC 응용 프로그램 만들기](../mfc/reference/creating-a-forms-based-mfc-application.md)<br>
[클래스 추가 대화 상자](../ide/add-class-dialog-box.md)<br>
