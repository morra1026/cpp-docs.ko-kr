...
이 단원에서는 전처리기의 정식 문법에 대하여 설명합니다. [전처리기](../preprocessor/preprocessor.md)와 [Pragma 지시문](../preprocessor/pragma-directives-and-the-pragma-keyword.md)에 관련된 전처리를 위한 지시문과 연산자에 대한 문법을 설명합니다.
