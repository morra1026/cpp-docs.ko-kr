...
- [런타임 시 ODBC 데이터 원본의 스키마 결정](../../data/odbc/data-source-determining-the-schema-of-the-data-source-odbc.md)
...
- [ODBC 데이터 원본에서 프로그래밍 방식으로 테이블 작성](../../data/odbc/data-source-programmatically-creating-a-table-in-an-odbc-data-source.md)
