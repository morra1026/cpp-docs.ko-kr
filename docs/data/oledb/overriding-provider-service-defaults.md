...
ms.locfileid: "51556298"
---
# <a name="overriding-provider-service-defaults"></a>공급자 서비스 기본값 재정의

OLEDB_SERVICES에 대 한 공급자의 레지스트리 값에 대 한 기본 값으로 반환 됩니다 합니다 [DBPROP_INIT_OLEDBSERVICES](https://docs.microsoft.com/previous-versions/windows/desktop/ms716898(v=vs.85)) 데이터 원본 개체의 초기화 속성입니다.
...
[리소스 풀링](https://docs.microsoft.com/previous-versions/windows/desktop/ms713655(v=vs.85))<br/>
[리소스 풀링을 소비자를 사용 하는 방법](https://docs.microsoft.com/previous-versions/windows/desktop/ms715907(v=vs.85))<br/>
[공급자를 사용 방법을 효과적으로 리소스 풀링](https://docs.microsoft.com/previous-versions/windows/desktop/ms714906(v=vs.85))<br/>
