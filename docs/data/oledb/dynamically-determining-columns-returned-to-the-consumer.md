...
처리 하는 `IColumnsInfo::GetColumnsInfo` 호출 함수를 정의 하는 PROVIDER_COLUMN_MAP, 삭제, `GetColumnInfo`에서 `CAgentMan` 에서 사용자 레코드 *사용자 지정*RS.h 및 자체에 대 한 정의 사용 하 여 바꾸기 `GetColumnInfo` 함수:  
