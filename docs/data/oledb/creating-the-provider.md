...
1. 에 **클래스 추가** 대화 상자에서를 **ATL OLE DB Provider** 아이콘을 클릭 하 고 **열기**합니다.

1. ATL OLE DB 공급자 마법사에서 공급자의 약식 이름을 입력 합니다 **약식 이름** 상자입니다. 다음 항목의 짧은 이름을 "MyProvider"를 사용 하지만 다른 이름을 사용할 수 있습니다. 다른 이름 입력란을 입력 하는 이름에 따라 채워집니다.
