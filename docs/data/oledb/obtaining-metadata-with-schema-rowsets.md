...
제한 열을 포함 하 여 OLE DB 스키마 행 집합에 대 한 자세한 내용은 참조 [부록 b: 스키마 행 집합](/previous-versions/windows/desktop/ms712921) 에 **OLE DB Programmer's Reference**합니다.
