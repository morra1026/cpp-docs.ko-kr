...
DDX 함수를 사용할 수 있습니다 `COleDbRecordView` 데이터베이스 레코드 집합에서 직접 데이터 가져오기 및 대화 상자 컨트롤에 표시 합니다. 사용 해야 합니다 **DDX_** <strong>\*</strong> 메서드 (같은 `DDX_Text`)이 아니라는 **DDX_Field** <strong>\*</strong> 함수 (같은 `DDX_FieldText`)와 `COleDbRecordView`합니다.  
