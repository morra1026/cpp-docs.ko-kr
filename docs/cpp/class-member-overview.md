...
데이터 멤버는 정적 멤버로 선언할 수 있습니다. 이 경우 클래스의 모든 개체가 동일한 복사본에 액세스할 수 있게 됩니다. 멤버 함수를 선언할 수 있습니다 정적 함수로 경우 클래스의 정적 데이터 멤버만 액세스할 수 있습니다 (없음 *이* 포인터). 자세한 내용은 [정적 데이터 멤버](../cpp/static-members-cpp.md)합니다.
...
주어진 클래스 형식의 모든 개체에 대해 정적 데이터 멤버의 공유 복사본이 한 개만 있습니다. 정적 데이터 멤버를 정의해야 하며 파일 범위에서 초기화할 수 있습니다. (정적 데이터 멤버에 대 한 자세한 내용은 참조 하십시오 [정적 데이터 멤버](../cpp/static-members-cpp.md).) 다음 예제에서는 이 초기화를 수행하는 방법을 보여 줍니다.
