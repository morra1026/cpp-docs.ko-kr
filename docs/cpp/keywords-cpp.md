...
|[에서는 for each](../dotnet/for-each-in.md)|[friend](friend-cpp.md)|[friend_as](../preprocessor/hash-using-directive-cpp.md)|[gcnew](../windows/ref-new-gcnew-cpp-component-extensions.md)|
|[제네릭](../windows/generics-cpp-component-extensions.md)|[goto](goto-statement-cpp.md)|[if](if-else-statement-cpp.md)|[initonly](../dotnet/initonly-cpp-cli.md)|
|[인라인](inline-functions-cpp.md)|[int](fundamental-types-cpp.md)|[인터페이스 클래스](../windows/interface-class-cpp-component-extensions.md)|[인터페이스 구조체](../windows/interface-class-cpp-component-extensions.md)|
|[interior_ptr](../windows/interior-ptr-cpp-cli.md)|[name](../windows/literal-cpp-component-extensions.md)|[long](fundamental-types-cpp.md)|[변경할 수](mutable-data-members-cpp.md)|
...
|[속성](../windows/property-cpp-component-extensions.md)|[속성](property-cpp.md) <sup>1</sup>|[protected](protected-cpp.md)|[public](public-cpp.md)|
|[ref 클래스](../windows/classes-and-structs-cpp-component-extensions.md)|[ref 구조체](../windows/classes-and-structs-cpp-component-extensions.md)|[register](storage-classes-cpp.md#register)|[reinterpret_cast](reinterpret-cast-operator.md)|
...
|[서식 파일](templates-cpp.md)|[this](this-pointer.md)|[스레드](thread.md) <sup>1</sup>|[throw](try-throw-and-catch-statements-cpp.md)|
...
|[사용 하 여](using-declaration.md) 선언|[사용 하 여](namespaces-cpp.md#using_directives) 지시문|[uuid](uuid-cpp.md) <sup>1</sup>|[값 클래스](../windows/classes-and-structs-cpp-component-extensions.md)|
|[값 구조체](../windows/classes-and-structs-cpp-component-extensions.md)|[virtual](virtual-cpp.md)|[void](void-cpp.md)|[volatile](volatile-cpp.md)|
|[while](while-statement-cpp.md)|

<sup>1</sup> 확장에 대 한 특성을 **__declspec** 키워드입니다.

<sup>2</sup> Managed Extensions for c + +만 해당 합니다. 이 구문은 이제 사용되지 않습니다. 참조 [런타임 플랫폼용 구성 요소 확장명](../windows/component-extensions-for-runtime-platforms.md) 자세한 내용은 합니다.

<sup>3</sup> 이벤트 처리에 사용 되는 내장 함수입니다.

<sup>4</sup> 이러한 키워드는 사용 가능한 이전 버전을 사용 하 여 이전 버전과 호환성을 위해 선행 밑줄이 두 개 및 Microsoft 확장 되 면 단일 선행 밑줄을 사용 하 여 모두 (기본값)를 사용 합니다.
...
Microsoft 확장은 기본적으로 사용하도록 설정됩니다. 프로그램은 완전히 이식 가능 하도록 지정 하 여 Microsoft 확장을 비활성화할 수 있습니다 합니다 [/Za \(언어 확장 사용 안 함)](../build/reference/za-ze-disable-language-extensions.md) 컴파일하는 동안 옵션입니다. 이렇게 하면 일부 Microsoft 전용 키워드는 사용할 수 없습니다.
