...
**struct** 키워드는 구조체의 형식 그리고, 또는 구조체 형식 변수를 정의합니다.
...
*템플릿 사양*<br/>
선택적으로 사용할 수 있으며 템플릿을 지정니다. 자세한 내용은 [템플릿 지정](templates-cpp.md)을 참조합니다.
...
*member-list*<br/>
구조체 멤버 목록입니다. 저 자세한 내용은 [클래스 멤버 개요](../cpp/class-member-overview.md)를 참조합니다. 유일한 차이점은 **class** 대신 **struct**이 사용되는것 입니다.
...
닫는 중괄호와 세미콜론 사이에 쉼표로 구분된 변수 이름을 하나이상 넣어 구조체 형식이 정의될 때 변수를 선언할 수 있습니다.
