...
컴파일러는 가능한 일치 함수 템플릿 중에서 가장 특수화된 것을 선택합니다. 예를 들어, 한 함수 템플릿에서 __T__ 형식을 사용하고 다른 함수 템플릿에서도 __T\*__ 를 사용하는 경우 __T\*__ 버전은 더욱 특수화된 것으로 간주되며 인수가 포인터 형식일 때 동일하게 사용할 수 있는 제네릭 __T__ 버전보다 선호됩니다.
