...
|[SafeInt 라이브러리](../windows/safeint-library.md)|오버플로의 위험 없이 정수를 처리하는 함수 라이브러리에 대한 참조 콘텐츠입니다.|
|[Visual C++](../visual-cpp-in-visual-studio.md)|Visual Studio에 포함된 Visual C++의 주요 기능을 설명하고 Visual C++ 설명서 각 부분에 대한 정보를 제공합니다.|
...
|[Visual C++의 새로운 기능](../what-s-new-for-visual-cpp-in-visual-studio.md)|이번 릴리스의 새 기능과 향상된 기능에 대해 설명합니다.|