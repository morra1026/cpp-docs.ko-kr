...
설명서의이 섹션에서는 지침 및 Microsoft C 및 c + + 용 ISO 표준의 구현에 대 한 참조 콘텐츠를 포함합니다.
...
|[SafeInt 라이브러리](../windows/safeint-library.md)|오버플로의 위험 없이 정수를 처리 하는 함수 라이브러리에 대 한 참조 콘텐츠입니다.|
|[Visual C++](../visual-cpp-in-visual-studio.md)|Visual Studio에 포함된 Visual C++의 주요 기능을 설명하고 Visual C++ 설명서의 나머지 부분에 연결합니다.|
|[IDE 및 개발 도구](../ide/ide-and-tools-for-visual-cpp-development.md)|링크를 만들려면 Visual Studio 및 관련된 도구를 사용 하는 방법에 대 한 정보를 포함 하는 다른 문서를 빌드하고 c + + 앱을 배포 합니다.|
|[Visual C++의 새로운 기능](../what-s-new-for-visual-cpp-in-visual-studio.md)|새 기능과이 릴리스에서 향상 된 기능에 설명 합니다.|