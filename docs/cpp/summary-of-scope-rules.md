...
## <a name="constructor-initializers"></a>생성자 이니셜라이저  
 생성자 이니셜라이저 (에서 설명한 [초기화 기본 항목 및 멤버](https://msdn.microsoft.com/2f71377e-2b6b-49da-9a26-18e9b40226a1))는 지정 된 생성자의 가장 바깥쪽 블록의 범위에서 계산 됩니다. 따라서 생성자의 매개 변수 이름을 사용할 수 있습니다.  
