...
|이름|설명|
|----------|-----------------|
|[concurrent_unordered_set](#ctor)|오버로드됨. 순서가 지정 되지 않은 동시 집합을 생성합니다.|
...
|[insert](#insert)|오버로드됨. 요소를 추가 하 여 `concurrent_unordered_set` 개체입니다.|
|[key_eq](#key_eq)|저장 된 같음 비교 함수 개체를 반환합니다.|
|[swap](#swap)|두의 내용을 바꿉니다 `concurrent_unordered_set` 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.|
|[unsafe_erase](#unsafe_erase)|오버로드됨. 요소를 제거 합니다 `concurrent_unordered_set` 지정 된 위치에 있습니다. 이 메서드는 동시성이 보장 되지 않습니다.|

### <a name="public-operators"></a>Public 연산자

|이름|설명|
|----------|-----------------|
|[operator=](#operator_eq)|오버로드됨. 다른 내용을 할당 `concurrent_unordered_set` 여기에 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.|

## <a name="remarks"></a>설명

대 한 자세한 내용은 합니다 `concurrent_unordered_set` 클래스를 참조 하십시오 [병렬 컨테이너 및 개체](../../../parallel/concrt/parallel-containers-and-objects.md)합니다.
...
요소를 추가 하 여 `concurrent_unordered_set` 개체입니다.
...
다른 내용을 할당 `concurrent_unordered_set` 여기에 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.
...
두의 내용을 바꿉니다 `concurrent_unordered_set` 개체입니다. 이 메서드는 동시성이 보장 되지 않습니다.
...
요소를 제거 합니다 `concurrent_unordered_set` 지정 된 위치에 있습니다. 이 메서드는 동시성이 보장 되지 않습니다.
