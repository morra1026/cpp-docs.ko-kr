...
사용 하는 전체 예제는 `parallel_for` 알고리즘을 참조 하세요 [방법: parallel_for 루프 작성](../../parallel/concrt/how-to-write-a-parallel-for-loop.md)합니다.
...
사용 하는 전체 예제는 `parallel_for_each` 알고리즘을 참조 하세요 [방법: parallel_for_each 루프 작성](../../parallel/concrt/how-to-write-a-parallel-for-each-loop.md)합니다.
...
사용 하는 전체 예제는 `parallel_invoke` 알고리즘을 참조 하세요 [방법: parallel_invoke를 사용 하 여 병렬 정렬 루틴 작성](../../parallel/concrt/how-to-use-parallel-invoke-to-write-a-parallel-sort-routine.md) 및 [하는 방법: parallel_invoke 병렬 작업 실행을 사용 하 여](../../parallel/concrt/how-to-use-parallel-invoke-to-execute-parallel-operations.md).
...
지도 수행 하 고 병렬로 작업을 줄여 주는 다른 예제를 참조 하세요 [방법: 지도 수행 및 병렬 작업 줄이기](../../parallel/concrt/how-to-perform-map-and-reduce-operations-in-parallel.md)합니다.
