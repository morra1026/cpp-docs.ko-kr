...
2.  주요 색상으로 red에 있는 모든 이미지에 대 한 녹색 및 파랑 구성 요소를 제거 하 고 어둡게 만듭니다.  
  
3.  다른 이미지에 대 한 세피아 톤을 적용 합니다.  
...
2.  에 `ProcessImages` 함수를 만들기는 `countdown_event` 변수입니다. `countdown_event` 클래스는이 연습의 뒷부분에서 표시 됩니다.  
...
5.  네트워크를 연결 하는 다음 코드를 추가 합니다.  
  
     [!code-cpp[concrt-image-processing-filter#11](../../parallel/concrt/codesnippet/cpp/walkthrough-creating-an-image-processing-network_10.cpp)]  
  
6.  보낼 네트워크의 머리에 각 JPEG 파일의 전체 경로 디렉터리에 다음 코드를 추가 합니다.  
  
     [!code-cpp[concrt-image-processing-filter#12](../../parallel/concrt/codesnippet/cpp/walkthrough-creating-an-image-processing-network_11.cpp)]  
  
7.  대기는 `countdown_event` 변수를 0에 도달 합니다.  
