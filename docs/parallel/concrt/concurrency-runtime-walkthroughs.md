...
[연습: Futures 구현](../../parallel/concrt/walkthrough-implementing-futures.md)<br/>
나중에 사용할 값을 비동기적으로 계산하는 방법을 보여 줍니다.

[연습: join을 사용하여 교착 상태 방지](../../parallel/concrt/walkthrough-using-join-to-prevent-deadlock.md)<br/>
