...
중첩 된 병렬 처리 수준 지정 된 [omp_set_nested](../../../parallel/openmp/reference/omp-set-nested.md) 하 고 [OMP_NESTED](../../../parallel/openmp/reference/omp-nested.md)합니다.
