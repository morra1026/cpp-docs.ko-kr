...
## <a name="construction"></a>생성  
 [1] 생성자  
 D3D 액세스 잠금을 획득는 주어진 [accelerator_view](accelerator-view-class.md) 개체입니다. 잠금을 가져올 때까지 요소를 생성 합니다.  
  
 [2] 생성자  
 D3D 액세스 잠금을 채택는 주어진 [accelerator_view](accelerator-view-class.md) 개체입니다.  
  
 [3] 이동 생성자  
 다른 기존 D3D 액세스 잠금을 사용 `scoped_d3d_access_lock` 개체입니다. 생성을 차단 하지 않습니다.  
