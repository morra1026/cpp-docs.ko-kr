---
title: double_3 클래스 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
ms.locfileid: "46027754"
---
# <a name="double3-class"></a>double_3 클래스
세 개의 double의 짧은 벡터를 나타냅니다.  
...
|이름|설명|  
|----------|-----------------|  
|[double_3 생성자](#ctor)|오버로드됨. 기본 생성자가 0 인 모든 요소를 초기화 합니다.|  
