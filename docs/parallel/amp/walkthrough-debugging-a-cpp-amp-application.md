---
title: '연습: c + + AMP 응용 프로그램 디버그 | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
5. 선택 합니다 **조사식 추가** 다시 열 머리글을 입력 `localA[localIdx[0]]`를 선택한 후는 **Enter** 키입니다.  
     ...
     ![정렬 된 결과 사용 하 여 병렬 조사식 창](../../parallel/amp/media/campf.png "campf")  
 정렬 결과  
...
3. 현재 행에 대 한 바로 가기 메뉴를 열고 선택한 **Freeze**합니다.  
     ...
     ![고정 된 스레드를 표시 하는 GPU 스레드 창을](../../parallel/amp/media/campk.png "campk")  
