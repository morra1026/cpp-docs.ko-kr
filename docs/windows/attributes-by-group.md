...
|특성|설명|
|---------------|-----------------|
|[COM 특성](../windows/com-attributes.md)|COM 및.NET Framework 공용 언어 런타임 개발의 다양 한 영역을 지 원하는 코드를 삽입 합니다.|
|[IDL 특성](../windows/idl-attributes.md)|구조체의 기술 및 해당 파일의 구문은 않고 마법사를 사용 하지 않고 소스 코드 파일에서.idl 파일의 수정이 가능 합니다.|
