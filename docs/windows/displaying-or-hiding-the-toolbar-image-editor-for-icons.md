---
title: 표시 또는 숨기기 (아이콘에 대 한 이미지 편집기) 도구 모음 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "42602614"
---
# <a name="displaying-or-hiding-the-toolbar-image-editor-for-icons"></a>도구 모음 표시 또는 숨기기(아이콘에 대한 이미지 편집기)
