---
title: '아이콘 및 커서: 디스플레이 장치용 (아이콘에 대 한 c + + 이미지 편집기) 이미지 리소스'
ms.date: 11/04/2016
f1_keywords:
- vc.editors.icon
helpviewer_keywords:
...
아이콘 및 커서는 다양한 유형의 디스플레이 디바이스에 맞는 다양한 크기 및 색 구성표의 여러 이미지를 포함할 수 있는 그래픽 리소스입니다. 또한 커서에는 Windows에서 해당 위치를 추적하는 데 사용하는 위치인 "핫스팟"이 있습니다. 아이콘 및 커서 모두 만들어지고 사용 하 여 편집 합니다 **이미지** 편집기, 비트맵 및 기타 이미지는 합니다.
