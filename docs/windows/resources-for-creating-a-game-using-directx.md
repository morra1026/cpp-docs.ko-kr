...
Windows 8.1 이상, DirectX SDK는 Windows SDK에 포함 됩니다. 다른 기능을 별도로 다운로드하지 않아도 됩니다. 자세한 내용은 [Where is DirectX SDK?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx)합니다.
