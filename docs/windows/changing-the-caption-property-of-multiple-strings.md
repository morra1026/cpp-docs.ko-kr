---
title: 여러 문자열 리소스 (c + +)의 Caption 속성 변경 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "50057753"
---
# <a name="changing-the-caption-property-of-multiple-string-resources-c"></a>여러 문자열 리소스 (c + +)의 Caption 속성 변경
