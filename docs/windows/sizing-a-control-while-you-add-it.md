---
title: 컨트롤을 추가할 때 크기 조정 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. 대화 상자에 새 컨트롤의 왼쪽 위 모퉁이 만들려는 (십자)는 커서를 놓습니다.

3. 클릭 하 고 대화 상자에서 컨트롤의 왼쪽 위 모퉁이 고정 하려면 마우스 버튼 컨트롤 원하는 크기가 될 때까지 커서를 오른쪽 아래로 끕니다.

   > [!NOTE]
   > 실제로 그릴 컨트롤의 네 모퉁이 고정할 수 있습니다. 이 절차 예를 들어 왼쪽 위 모퉁이 사용 합니다.

4. 마우스 단추를 놓습니다. 컨트롤의 대화 상자에서 지정한 크기에 도달 합니다.
