...
1. 프로그램 내에서 버전 정보에 액세스하려는 경우 [GetFileVersionInfo](/windows/desktop/api/winver/nf-winver-getfileversioninfoa) 함수 및 [VerQueryValue](/windows/desktop/api/winver/nf-winver-verqueryvaluea) 함수를 사용합니다.
