...
ms.locfileid: "56320629"
---
# <a name="how-to-manage-resources-c"></a>방법: 관리 리소스 (c + +)

## <a name="copy-resources"></a>리소스 복사
...
### <a name="change-the-language-or-condition-of-a-resource-while-copying"></a>복사 하는 동안 언어 또는 리소스의 상태 변경
...
1. 선택할 **복사본 삽입** 집합 다음 바로 가기 메뉴에서:

   - 에 대 한 합니다 **언어** 목록 상자에서 언어를 선택 합니다.

   - 에 **조건을** 상자에서 조건을 입력 합니다.

## <a name="edit-resources"></a>리소스 편집
...
1. 선택 **내보내기** 바로 가기 메뉴 및 현재 파일 이름을 적용 하거나 새 이름을 입력 합니다.
