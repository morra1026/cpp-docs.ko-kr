...
|이름|설명|
|----------|-----------------|
|[HANDLENullTraits::Close 메서드](../windows/handlenulltraits-close-method.md)|지정된 된 핸들을 닫습니다.|
|[HANDLENullTraits::GetInvalidValue 메서드](../windows/handlenulltraits-getinvalidvalue-method.md)|잘못 된 핸들을 나타냅니다.|
