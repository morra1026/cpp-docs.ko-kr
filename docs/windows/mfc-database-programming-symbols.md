---
title: MFC 데이터베이스 프로그래밍 기호 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|AFX_IDP_SQL_FIELD_NOT_FOUND|AFX_IDP_SQL_FILED_SCHEMA_ 일치 하지 않습니다.|
...
|AFX_IDP_SQL_NO_POSITIONED_ 업데이트|AFX_IDP_SQL_NO_ROWS_AFFECTED|
