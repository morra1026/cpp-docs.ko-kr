...
|**Change**|열립니다는 **기호 변경** 대화 상자를 이름 또는 기호 값을 변경할 수 있습니다. 사용 중인 컨트롤 또는 리소스에 대한 기호인 경우 해당 리소스 편집기에서만 기호를 변경할 수 있습니다. 자세한 내용은 [기호 관리](../windows/changing-unassigned-symbols.md)합니다.|
