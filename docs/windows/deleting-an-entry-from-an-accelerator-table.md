---
title: 액셀러레이터 키 테이블에서 항목 삭제 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "42605409"
---
# <a name="deleting-an-entry-from-an-accelerator-table"></a>액셀러레이터 키 테이블에서 항목 삭제
...
2. 삭제하려는 항목을 선택합니다. (누른 합니다 **Ctrl** 또는 **Shift** 키를 클릭 하는 동안 여러 항목을 선택 합니다.)

3. 마우스 오른쪽 단추로 **삭제** 바로 가기 메뉴에서 (누르거나 **삭제** 에서 합니다 **편집** 메뉴).
