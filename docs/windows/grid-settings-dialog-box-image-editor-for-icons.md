---
title: 모눈 설정 대화 상자 (c + +) (아이콘에 대 한 이미지 편집기)
ms.date: 11/04/2016
f1_keywords:
...
- **픽셀 모눈**
   ...
   옵션을 선택 하면 이미지 편집기의 각 픽셀 관련 표를 표시 합니다. 표 4 × 및 더 높은 해상도에 나타납니다.
...
- **너비**
   ...
   각 타일 블록의 너비를 지정합니다. 정기적으로 정렬 된 여러 이미지를 포함 하는 비트맵을 그릴 때 유용 합니다.

- **높이**

   각 타일 블록의 높이 지정합니다. 정기적으로 정렬 된 여러 이미지를 포함 하는 비트맵을 그릴 때 유용 합니다.
