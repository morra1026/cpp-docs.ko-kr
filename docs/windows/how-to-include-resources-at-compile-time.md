...
ms.locfileid: "56320668"
---
# <a name="how-to-include-resources-at-compile-time-c"></a>방법: (C + +) 컴파일 타임에 리소스 포함

일반적으로 쉽고 편리 하 게 하나의 리소스 스크립트 (.rc) 파일에서 모든 리소스의 기본 배열을 사용 하는 것이 것입니다. 그러나 여러 가지가 있습니다 주.rc 파일이 아닌 파일에 리소스를 배치 합니다.
...
하면 리소스를 추가할 수 다른 파일의 현재 프로젝트 컴파일 타임에 나열 합니다 **컴파일 시간 지시문** 상자에 **리소스 내용** 대화 상자.
...
열려는 합니다 **리소스 내용** 대화 상자에서 마우스 오른쪽 단추로 클릭.rc 파일 [리소스 뷰](../windows/resource-view-window.md), 선택한 **리소스 내용** 바로 가기 메뉴에서. 다음 속성을 참조 하세요.
...
1. **편집할** 메뉴 선택 [기호 찾기](/visualstudio/ide/go-to)합니다.
...
[리소스 만들기](../windows/how-to-create-a-resource-script-file.md)<br/>
