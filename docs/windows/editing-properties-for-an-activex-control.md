---
title: ActiveX 컨트롤 속성 편집 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. 에 **뷰** 메뉴에서 클릭 **속성 페이지** 속성을 확인 합니다.

3. 속성 페이지에서 필요에 따라 변경 합니다.
...
[ActiveX 컨트롤 보기 및 대화 상자에 추가](../windows/viewing-and-adding-activex-controls-to-a-dialog-box.md)  
