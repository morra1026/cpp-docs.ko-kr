---
title: ref new, gcnew (C + + /cli 및 C + + /cli CX)
ms.date: 10/12/2018
ms.topic: reference
f1_keywords:
- gcnew
...
사용 하 여 **ref n e w** 수명을 자동으로 관리 하려는 Windows 런타임 개체에 대 한 메모리를 할당할 수 있습니다. 참조 개수가 0이 되면 개체는 자동으로 할당 취소되며, 참조의 마지막 복사본이 범위를 벗어난 후에 발생합니다. 자세한 내용은 [Ref 클래스 및 구조체](../cppcx/ref-classes-and-structs-c-cx.md)합니다.
