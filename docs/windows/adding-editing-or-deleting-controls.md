---
title: 추가, 편집 또는 삭제 컨트롤 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
바로 가기 메뉴를 사용할 수는 **대화 상자** 신속 하 게 추가할 편집기 대화 상자에 ActiveX 컨트롤을 등록 하 고 ActiveX 컨트롤을 추가할 수 있습니다 합니다 **도구 상자** 빠른 액세스를 위해 (자세한 내용은 참조 [사용자 지정 도구 상자 대화 상자](http://msdn.microsoft.com/bd07835f-18a8-433e-bccc-7141f65263bb)).
