...
|제목|설명|
|-----------|-----------------|
|[C++의 Windows 콘솔 응용 프로그램](console-applications-in-visual-cpp.md)|콘솔 앱에 대한 정보를 얻을 수 있습니다. Win32 또는 Win64 콘솔 응용 프로그램에는 고유의 창이나 메시지 루프가 없습니다. 콘솔 창에서 실행되고 입력 및 출력이 명령줄을 통해 처리됩니다.|
...
[Visual Studio의 Visual C++](../visual-cpp-in-visual-studio.md)