---
title: 특성 (c + + COM 특성) | Microsoft Docs
ms.custom: ''
ms.date: 10/03/2018
ms.technology:
- cpp-windows
...
> [!NOTE]
> 합니다 **특성** 특성은 이제 사용 되지 않습니다.  공용 언어 런타임 특성을 사용 하 여 `System.Attribute` 를 직접를 사용자 정의 특성을 만듭니다. 자세한 내용은 [사용자 정의 특성](../user-defined-attributes-cpp-component-extensions.md)합니다.

정의 하는 [사용자 지정 특성](custom-attributes-cpp.md) 배치 하 여는 **특성** 관리 되는 클래스 또는 구조체 정의 특성으로 합니다. 클래스의 이름을 사용자 지정 특성입니다. 예를 들어:
...
가능한 특성 매개 변수 형식의 목록, 참조 [사용자 지정 특성](custom-attributes-cpp.md)합니다.

참조 [사용자 정의 특성](../user-defined-attributes-cpp-component-extensions.md) 특성 대상에 대 한 논의 합니다.
