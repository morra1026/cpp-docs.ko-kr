---
title: defaultbind (c + + COM 특성) | Microsoft Docs
ms.custom: ''
ms.date: 10/02/2018
ms.technology:
- cpp-windows
...
합니다 **defaultbind** c + + 특성에 동일한 기능을 합니다 [defaultbind](/windows/desktop/Midl/defaultbind) MIDL 특성입니다.
