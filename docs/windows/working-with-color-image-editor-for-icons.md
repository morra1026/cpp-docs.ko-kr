...
## <a name="select-foreground-or-background-colors"></a>전경색 또는 배경색 선택
...
마우스 왼쪽된 단추를 사용 하 여에서 원하는 색을 선택 합니다 **색** 색상표입니다.

### <a name="to-select-a-background-color"></a>배경색을 선택하려면

마우스 오른쪽 단추를 사용 하 여에서 원하는 색을 선택 합니다 **색** 색상표입니다.

## <a name="filling-a-bounded-area-of-an-image-with-a-color"></a>이미지 경계 영역을 색으로 채우기
...
1. 에 **이미지 편집기** 도구 모음 (또는 **이미지** 메뉴에서 **도구** 명령)을 선택 합니다 **채우기** 도구.
...
## <a name="pick-up-a-color-from-an-image-to-use-elsewhere"></a>다른 곳에서 사용 하는 이미지에서 색을 선택 합니다.
...
## <a name="choose-a-transparent-or-opaque-background"></a>투명 또는 불투명 배경 선택
...
## <a name="invert-the-colors-in-a-selection"></a>선택 영역에서 색 반전

합니다 **이미지** 편집기는 반전 된 색을 사용 하 여 이미지로 형태가 나타나는 방법을 알릴 수 있도록 이미지의 선택한 부분에서 색을 반전 하는 편리한 방법을 제공 합니다.

### <a name="to-invert-colors-in-the-current-selection"></a>현재 선택 영역의 색을 반전하려면

에 **이미지** 메뉴에서 **색 반전**합니다.

## <a name="customize-or-change-colors"></a>사용자 지정 또는 색 변경

합니다 **이미지** 편집자 **색** 16 개의 표준 색 팔레트에 처음에 표시 됩니다. 표시 된 색을 사용 하 여 사용자 지정 색도 만들 수 있습니다. 그런 다음 [저장 하 고 사용자 지정된 색 색상표 로드](../windows/saving-and-loading-different-color-palettes-image-editor-for-icons.md)합니다.
...
## <a name="save-and-load-different-color-palettes"></a>저장 하 고 다른 색 색상표 로드
...
### <a name="to-display-the-colors-window"></a>색 창을 표시 하려면

마우스 오른쪽 단추로 클릭는 **이미지 편집기** 창 선택 **색상 창 표시** 바로 가기 메뉴에서.

   \- 또는 -

선택 **색상 창 표시** 에 [이미지 메뉴](../windows/image-menu-image-editor-for-icons.md)합니다.

### <a name="to-hide-the-colors-window"></a>색 창을 숨기려면

창 고정을 해제 합니다. 이 작업을 사용 하 여에 없는 경우 자동 숨기기 창을 통해.
