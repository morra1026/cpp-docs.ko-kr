...
## <a name="saving-bitmaps-as-gifs-or-jpegs"></a>비트맵을 GIF 또는 JPEG로 저장
...
1. 열려 있는 상태에서 비트맵을 사용 하 여는 **이미지** 편집기 **저장 *filename*으로.bmp** 에 **파일** 메뉴.
...
## <a name="converting-an-image-from-one-format-to-another"></a>이미지를 한 형식에서 다른 형식으로 변환
