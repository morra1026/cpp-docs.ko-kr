---
title: '방법: 사용 추적 참조 C + + /cli CLI | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
다음 예제를 보여 줍니다는 수행 추적 참조의 주소를 반환 합니다는 [interior_ptr (C + + CLI)](../windows/interior-ptr-cpp-cli.md), 수정 및 추적 참조를 통해 데이터에 액세스 하는 방법을 보여줍니다.
