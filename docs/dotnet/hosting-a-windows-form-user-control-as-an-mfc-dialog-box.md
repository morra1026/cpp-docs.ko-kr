---
title: 호스트는 Windows Form 사용자 컨트롤을 MFC 대화 상자로 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
4.  추가 `#include <afxwinforms.h>` stdafx.h에서 기존 끝 `#include` 문입니다.  
  
5.  새 클래스를 서브클래싱하는 추가 `CDialog`합니다.  
...
6.  바꿉니다 `CDialog` CHostForWinForm.h 및 CHostForWinForm.cpp 파일에서 `CWinFormsDialog<WindowsControlLibrary1::UserControl1>`합니다.  
  
7.  CHostForWinForm 클래스에서 DoModal을 호출 합니다.  
