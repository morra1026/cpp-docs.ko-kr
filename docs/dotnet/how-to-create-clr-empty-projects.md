---
title: '방법: CLR 빈 프로젝트 만들기 | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
2.  아래 **설치 된 템플릿**, 클릭 합니다 **Visual c + +** 노드 클릭 합니다 **CLR** 노드. 선택 된 **CLR 빈 프로젝트** 아이콘입니다.  
  
3.  **이름** 상자에 응용 프로그램의 고유 이름을 입력합니다.  
  
    > [!NOTE]
    >  다른 프로젝트 및 솔루션 설정을 지정할 수도 있습니다는 **새 프로젝트** 대화 상자에서 했지만 이러한 설정이 필요 하지 않습니다.  
