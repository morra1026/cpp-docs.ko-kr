...
2.  [멤버 변수를 정의](../mfc/activex-control-containers-connecting-an-activex-control-to-a-member-variable.md) (또는 다른 형식의 액세스) ActiveX와 동일한 형식의 래퍼 클래스를 제어 합니다.  
  
3.  [ActiveX 컨트롤 프로그래밍](#_core_programming_the_activex_control) 미리 정의 된 래퍼 클래스의 멤버 함수를 사용 하 여 합니다.  
...
4.  주 대화 상자 템플릿을 두 번 클릭 합니다. 예를 들어 사용 하 여 **IDD_CONTAINER_DIALOG**합니다.  
  
5.  도구 상자에 Circ 컨트롤 아이콘을 클릭 합니다.  
  
6.  Circ 컨트롤 삽입 대화 상자 내에서 위치를 클릭 합니다.  
  
7.  **파일** 메뉴 선택 **모두 저장** 모든 수정 대화 상자 템플릿에 저장 하려면.  
