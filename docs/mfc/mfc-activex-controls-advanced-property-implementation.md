...
5.  에 **속성 이름이** 상자 속성의 이름을 입력 합니다.  
  
6.  **구현 형식**에서 **Get/Set 메서드**를 클릭합니다.  
  
7.  에 **속성 형식** 상자, 속성에 대 한 적절 한 유형을 선택 합니다.  
  
8.  읽기 전용 속성을 원하는 경우 집합 함수 이름의 선택을 취소 합니다. 쓰기 전용 속성을 원한다 면 Get 함수 이름의 선택을 취소 합니다.  
