...
- [WinInet을 인터넷에 대 한 Win32 API 함수에 알아봅니다](../mfc/wininet-basics.md)

- [WinInet을 사용 하 여와 관련 된 내용을 검토 프로그래밍](../mfc/win32-internet-extensions-wininet.md)
...
- [HTTP 클라이언트 응용 프로그램 작성](../mfc/steps-in-a-typical-http-client-application.md)
