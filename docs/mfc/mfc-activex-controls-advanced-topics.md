...
5.  에 **속성 이름이** 상자에 입력 `Array`합니다.  
  
6.  에 **속성 형식** 상자에서 **짧은**합니다.  
  
7.  에 대 한 **구현** 유형을 클릭 **Get/Set 메서드가**합니다.  
  
8.  에 **Get 함수가** 및 **설정 함수** 상자, Get 및 Set 함수의 고유 이름을 입력 하거나 기본 이름을 적용 합니다.  
