...
-   표준 구현에 `InitInstance` 멤버 함수입니다.  
 ...
 응용 프로그램 클래스는 주 소스 파일과 프로젝트 헤더에 배치 됩니다. 클래스 및 생성 된 파일의 이름은 MFC 응용 프로그램 마법사에서 제공한 프로젝트 이름을 기반으로 합니다. 이러한 클래스에 대 한 코드를 볼 수는 가장 쉬운 방법은 방법은 [클래스 뷰](https://msdn.microsoft.com/8d7430a9-3e33-454c-a9e1-a85e3d2db925)합니다.  
