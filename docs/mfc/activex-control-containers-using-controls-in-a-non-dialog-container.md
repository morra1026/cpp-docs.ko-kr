...
3.  추가 된 `WM_CREATE` 클래스에 메시지 처리기 `CMyView`합니다.  
  
4.  처리기 함수에서 `CMyView::OnCreate`, 컨트롤의 호출 `Create` 함수를 사용 하는 **이** 부모 창으로 포인터:  
  
     [!code-cpp[NVC_MFC_AxCont#15](../mfc/codesnippet/cpp/activex-control-containers-using-controls-in-a-non-dialog-container_4.cpp)]  
  
5.  프로젝트를 다시 빌드합니다. 응용 프로그램의 뷰를 만들 때마다 Circ 컨트롤을 동적으로 생성 됩니다.  
