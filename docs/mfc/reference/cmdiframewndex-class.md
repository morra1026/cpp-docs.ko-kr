...
|[CMDIFrameWndEx::AreMDITabs](#aremditabs)|MDI 탭 기능을 MDI 탭 그룹 기능을 사용 하거나 사용 되는지 여부를 결정 합니다.|  
|[CMDIFrameWndEx::CanCovertControlBarToMDIChild](#cancovertcontrolbartomdichild)|프레임 창 탭된 문서로 도킹 창 변환할 수 있는지 여부를 확인 하기 위해 프레임 워크에서 호출 됩니다.|  
...
|[CMDIFrameWndEx::CreateNewWindow](#createnewwindow)|새 창을 만듭니다 하기 위해 프레임 워크에서 호출 됩니다.|  
...
|[CMDIFrameWndEx::EnableAutoHidePanes](#enableautohidepanes)|수 있도록 자동 숨기기 모드 창에 대 한 지정 된 측면 주 프레임 창에 컨트롤이 도킹 된 경우.|  
...
|[CMDIFrameWndEx::GetPane](#getpane)|지정 된 컨트롤 ID를 가진 창에 대 한 포인터를 반환 합니다.|  
|[CMDIFrameWndEx::GetDefaultResId](#getdefaultresid)|MDI 프레임 창의 공유 리소스의 ID를 반환 합니다.|  
|[CMDIFrameWndEx::GetMDITabGroups](#getmditabgroups)|목록을 MDI 탭 창에 반환 합니다.|  
|[CMDIFrameWndEx::GetMDITabs](#getmditabs)|밑줄이 그어진된 탭된 창에 대 한 참조를 반환합니다.|  
|[CMDIFrameWndEx::GetMDITabsContextMenuAllowedItems](#getmditabscontextmenualloweditems)|상황에 맞는 메뉴 항목은 MDI 탭 그룹 기능을 사용 하도록 설정 하는 경우에 사용할 결정 하는 플래그의 조합을 반환 합니다.|  
|[CMDIFrameWndEx::GetMenuBar](#getmenubar)|프레임 창에 연결 하는 메뉴 모음 개체에 대 한 포인터를 반환 합니다.|  
|[CMDIFrameWndEx::GetRibbonBar](#getribbonbar)|프레임에 대 한 리본 표시줄 컨트롤을 검색합니다.|  
|[CMDIFrameWndEx::GetTearOffBars](#gettearoffbars)|목록을 반환 합니다 [CPane](../../mfc/reference/cpane-class.md)-분리 상태에 있는 개체를 파생 합니다.|  
|`CMDIFrameWndEx::GetThisClass`|에 대 한 포인터를 얻으려면 프레임 워크에서 호출 된 [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) 이 클래스 형식과 연결 된 개체입니다.|  
...
|[CMDIFrameWndEx::IsMemberOfMDITabGroup](#ismemberofmditabgroup)|Windows MDI 탭 그룹에 있는 목록에서 지정된 된 탭된 창 인지 확인 합니다.|  
...
|[CMDIFrameWndEx::OnCloseMiniFrame](#oncloseminiframe)|사용자가 클릭할 때 프레임 워크에서 호출 된 **닫기** 부동 미니 프레임 창에 단추입니다.|  
|[CMDIFrameWndEx::OnClosePopupMenu](#onclosepopupmenu)|활성 팝업 메뉴에서 WM_DESTROY 메시지를 처리할 때 프레임워크에서 호출됩니다.|  
|[CMDIFrameWndEx::OnCmdMsg](#oncmdmsg)|명령 사용자 인터페이스 개체 업데이트를 라우팅하고 명령 메시지를 디스패치하기 위해 프레임 워크에서 호출 됩니다.|  
|[CMDIFrameWndEx::OnDrawMenuImage](#ondrawmenuimage)|메뉴 항목과 연결된 이미지를 그릴 때 프레임워크에서 호출됩니다.|  
|[CMDIFrameWndEx::OnDrawMenuLogo](#ondrawmenulogo)|프레임 워크에서 호출 하면를 [CMFCPopupMenu](../../mfc/reference/cmfcpopupmenu-class.md)WM_PAINT 메시지를 처리 합니다.|  
|[CMDIFrameWndEx::OnEraseMDIClientBackground](#onerasemdiclientbackground)|MDI 프레임 창은 WM_ERASEBKGND 메시지를 처리할 때 프레임 워크에서 호출 됩니다.|  
|[CMDIFrameWndEx::OnMenuButtonToolHitTest](#onmenubuttontoolhittest)|프레임 워크에서 호출 하면를 [CMFCToolBarButton](../../mfc/reference/cmfctoolbarbutton-class.md)개체에서 WM_NCHITTEST 메시지를 처리 합니다.|  
...
|[CMDIFrameWndEx::OnShowCustomizePane](#onshowcustomizepane)|빠른 사용자 지정 창 활성화 될 때 프레임 워크에서 호출 합니다.|  
|[CMDIFrameWndEx::OnShowMDITabContextMenu](#onshowmditabcontextmenu)|상황에 맞는 메뉴 탭 중 하나에 표시 될 때 프레임 워크에서 호출 됩니다. (유효한만 MDI 탭 그룹에 대 한 합니다.)|  
|[CMDIFrameWndEx::OnShowPanes](#onshowpanes)|표시 / 숨기기 창 프레임 워크에서 호출 됩니다.|  
...
|[CMDIFrameWndEx::ShowFullScreen](#showfullscreen)|주 프레임 일반 모드에서 전체 화면 모드로 전환합니다.|  
...
## <a name="remarks"></a>설명  
 MDI 응용 프로그램에서 확장 된 사용자 지정 기능을 사용 하려면 응용 프로그램의 MDI 프레임 창 클래스를 파생 `CMDIFrameWndEx` 대신 `CMDIFrameWnd`합니다.  
...
*bTail*<br/>
[in] 이 창 목록의 끝에 추가할지 여부를 지정 합니다.  
  
### <a name="return-value"></a>반환 값  
 창에 성공적으로 등록 되 면 0이 아닌 값을 반환 합니다. 창 고 도킹 관리자를 사용 하 여 이미 등록 되어 있으면 0을 반환 합니다.  
  
### <a name="remarks"></a>설명  
 각 창에 등록 해야 합니다는 [CDockingManager 클래스](../../mfc/reference/cdockingmanager-class.md) 도킹 레이아웃에 부품을 가질 수 있습니다. 이 메서드를 사용 하 여 특정 창을 도킹 하려면 고 도킹 관리자에 게 알립니다. 해당 창 등록 되 면 해당 맞춤 설정 및 유지 관리 하 고 도킹 관리자 창의 목록에서 위치에 따라 고 도킹 관리자에 맞춥니다.  
...
### <a name="parameters"></a>매개 변수  
*hdwp*<br/>
[in] 여러 창 위치 구조를 식별합니다. 호출 하 여이 값을 가져올 수 있습니다 `BeginDeferWindowPos`합니다.  
  
### <a name="remarks"></a>설명  
 프레임 창에 도킹 되는 모든 창 레이아웃을 다시 계산 하려면이 멤버 함수를 호출 합니다.  
  
##  <a name="aremditabs"></a>  CMDIFrameWndEx::AreMDITabs  
 MDI 탭 기능을 MDI 탭된 그룹 기능을 사용 하거나 사용 되는지 여부를 결정 합니다.  
...
### <a name="parameters"></a>매개 변수  
*pnMDITabsType*<br/>
[out] 사용할 수 있는 기능을 표시 하는 정수 변수에 대 한 포인터:  
...
### <a name="return-value"></a>반환 값  
 TRUE MDI 탭 또는 MDI 탭 그룹 사용 되는지 여부를 반환 합니다.  
  
 위의 기능 없으면 FALSE를 반환이 사용 됩니다.  
  
### <a name="remarks"></a>설명  
 사용 하 여 MDI 탭 또는 MDI 탭 그룹 여부를 확인 하려면이 함수를 사용 하도록 설정할지 프레임 창에 대 한 합니다. 사용 하 여 [CMDIFrameWndEx::EnableMDITabs](#enablemditabs) 사용 하도록 설정 하 여 MDI 탭 기능을 사용 하지 않도록 설정 합니다.  
  
 사용 하 여 [cmdiframewndex:: Enablemditabbedgroups](#enablemditabbedgroups) 를 사용 하 여 MDI 탭된 그룹 기능을 사용 하지 않도록 설정 합니다.  
  
##  <a name="cancovertcontrolbartomdichild"></a>  CMDIFrameWndEx::CanCovertControlBarToMDIChild  
 프레임 창 탭된 문서로 도킹 창 변환할 수 있는지 여부를 확인 하기 위해 프레임 워크에서 호출  
...
### <a name="return-value"></a>반환 값  
 탭된 문서 프레임 창 도킹 창 변환할 수 있으면 TRUE를 반환합니다 그렇지 않으면 FALSE를 반환합니다.  
  
### <a name="remarks"></a>설명  
 파생된 클래스에서이 메서드를 재정의 하 고 탭 문서로 도킹 창의 변환을 사용 하도록 설정 하려면 TRUE를 반환 합니다. 설정할 수 있습니다 [CMDIFrameWndEx::m_bCanCovertControlBarToMDIChild](#m_bcancovertcontrolbartomdichild) TRUE로 합니다.  
...
### <a name="return-value"></a>반환 값  
 도킹 창을 포함 하는 새 MDI 자식 창에 대 한 포인터를 반환 합니다.  
  
### <a name="remarks"></a>설명  
 이 메서드는 도킹 창을 탭 된 문서로 변환합니다. 이 메서드를 호출 하는 경우 프레임 워크 만듭니다는 [CMDIChildWndEx 클래스](../../mfc/reference/cmdichildwndex-class.md) 개체를 도킹 관리자에서 도킹 창을 제거 하 고 새 MDI 자식 창으로 도킹 창에 추가 합니다. MDI 자식 창에는 전체 클라이언트 영역에 맞게 도킹 창 크기 조정  
...
### <a name="parameters"></a>매개 변수  
*lpcszDocName*<br/>
[in] 문서 식별자가 포함 된 텍스트 문자열입니다. 일반적으로 문서 파일의 전체 경로입니다.  
  
*pObj*<br/>
[in] 사용자 정의 개체에 대 한 포인터입니다. 예를 들어, 개발자 문서를 설명 하 고 시작 시 문서를 초기화 해야 하는 방법을 지시 하는 응용 프로그램별 데이터 구조를 만들 수 있습니다.  
...
##  <a name="createnewwindow"></a>  CMDIFrameWndEx::CreateNewWindow  
 새 창을 만듭니다 하기 위해 프레임 워크에서 호출 됩니다.  
...
*nDockBarID*<br/>
[in] 프레임 창에 도킹 있는 쪽을 지정 합니다.  
  
*lpRect*<br/>
[in] 사용 되지 않습니다.  
  
### <a name="remarks"></a>설명  
 이 메서드는 지정 된 도킹 된 프레임 창의 어느 한쪽 창 때 지정 된 [CBasePane::EnableDocking](../../mfc/reference/cbasepane-class.md#enabledocking) 하 고 [CMDIFrameWndEx::EnableDocking](#enabledocking) 호출한.  
...
*pLeftOf*<br/>
[in] 창으로 도킹 사이트에 대 한 포인터입니다. .  
  
### <a name="return-value"></a>반환 값  
 작업이 성공한 경우 TRUE를 반환 합니다. 그렇지 않으면 FALSE를 반환합니다.  
  
### <a name="remarks"></a>설명  
 미리 정의 된 순서에 따라 여러 가지 창 개체를 도킹 하려면이 메서드를 호출 합니다. 이 메서드는 지정 된 창 도킹 *pBar* 로 지정 된 창의 왼쪽 *pLeftOf*합니다.  
...
##  <a name="enableautohidepanes"></a>  CMDIFrameWndEx::EnableAutoHidePanes  
 사용 하도록 설정 자동 숨기기 모드 창에 대 한 지정 된 측면 주 프레임 창에 컨트롤이 도킹 된 경우.  
...
### <a name="parameters"></a>매개 변수  
*dwDockStyle*<br/>
[in] 주 프레임 창 사용 될 측면을 지정 합니다. 다음 플래그 중 하나 이상을 사용 합니다.  
...
### <a name="return-value"></a>반환 값  
 지정 된 측면 주 프레임 창에 컨트롤이 도킹 된 때 창에 대 한 자동 숨기기 모드를 사용 하도록 설정 하려면이 함수를 호출 합니다.  
...
### <a name="parameters"></a>매개 변수  
*dwDockStyle*<br/>
[in] 적용 하려는 도킹 스타일을 지정 합니다.  
  
### <a name="return-value"></a>반환 값  
  
### <a name="remarks"></a>설명  
 에 속해 있는 창의 도킹을 사용 하도록 설정 하려면이 함수를 호출 합니다 `CMDIFrameWndEx` 개체입니다.  
...
### <a name="parameters"></a>매개 변수  
*bEnableMenu*<br/>
[in] 전체 화면 모드 또는 숨기려면 FALSE 주 메뉴를 표시 하려면 TRUE입니다.  
...
### <a name="parameters"></a>매개 변수  
*uiFullScreenCmd*<br/>
[in] ID 또는 전체 화면 모드를 해제 하는 명령입니다.  
  
### <a name="remarks"></a>설명  
 전체 화면 모드에서 모든 도킹 컨트롤 막대, 도구 모음 및 메뉴는 숨겨져 있으며, 활성 뷰가 전체 화면을 차지 하도록 크기가 조정 됩니다. 전체 화면 모드를 사용 하도록 설정 하거나이 사용 하지 않도록 설정 하는 명령 ID를 지정 해야 합니다. 호출할 수 있습니다 `EnableFullScreenMode` 주 프레임에서 `OnCreate` 함수입니다. 지정한 명령 ID를 가진 단추 하나를 사용 하 여 프레임 워크 부동 도구 모음을 만드는 프레임 창을 전체 화면 모드로 전환 되는 경우 화면에서 주 메뉴를 유지 하려는 경우 호출할 [CMDIFrameWndEx::EnableFullScreenMainMenu](#enablefullscreenmainmenu)합니다.  
...
### <a name="parameters"></a>매개 변수  
*bEnable*<br/>
[in] True 이면 MDI 탭된 그룹 기능을 사용 하도록 설정. FALSE 이면 MDI 탭된 그룹 기능을 사용할 수 없습니다.  
  
*params*<br/>
[in] 프레임 워크 MDI 클라이언트 영역에서 만든 자식 창에 적용 되는 매개 변수를 지정 합니다.  
  
### <a name="remarks"></a>설명  
 MDI 탭된 그룹 기능을 사용 하지 않도록 설정 하거나 사용 하려면이 메서드를 사용 합니다. 이 기능을 사용 하면 자식 창을 세로로 정렬 된 탭된 창으로 또는 MDI 클라이언트 영역 내에서 가로로 표시할 MDI 응용 프로그램입니다. 탭 창의 그룹은 분할자로 구분됩니다. 사용자는 분할자를 사용 하 여 탭된 그룹의 크기를 조정할 수 있습니다.  
...
-   응용 프로그램은 탭 창의 현재 레이아웃 및 현재 열린된 문서의 목록을 저장할 수 있습니다.  
  
 이 메서드를 호출 하는 경우 *bEnable* FALSE로 설정 되며 *params* 무시 됩니다.  
  
 MDI 탭 그룹은 이미 설정 된 경우에 다시 자식 창에 대 한 설정을 수정 하려면이 메서드를 호출할 수 있습니다. 메서드를 호출 *bEnable* TRUE로 설정 하 고의 멤버를 수정 합니다 `CMDITabInfo` 로 지정 되는 개체를 *params* 매개 변수.  
  
 탭 그룹을 MDI를 사용 하는 방법에 대 한 자세한 정보를 참조 하세요 [MDI 탭 그룹](../../mfc/mdi-tabbed-groups.md)합니다.  
...
##  <a name="enablemditabs"></a>  CMDIFrameWndEx::EnableMDITabs  
 사용 하거나 MDI 프레임 창에 대해 MDI 탭 기능을 사용 하지 않도록 설정 합니다. 사용 하도록 설정 하면 각 MDI 자식 창에 대 한 탭 프레임 창에 표시 됩니다.  
 ...
 *bTabCustomTooltips*  
 사용자 지정 도구 설명이 사용 되는지 여부를 지정 합니다.  
  
 *bActiveTabCloseButton*  
 TRUE 인 경우는 **닫기** 단추 오른쪽 모퉁이에 있는 탭 영역의 대신 활성 탭에 표시 됩니다.  
  
### <a name="remarks"></a>설명  
 MDI 프레임 창에 대해 MDI 탭 기능을 사용 하지 않도록 설정 하거나 사용 하려면이 메서드를 호출 합니다. 사용 하도록 설정 하면 모든 자식 창은 탭으로 표시 됩니다.  
  
 탭 레이블을 매개 변수의 설정에 따라 고 프레임 맨 위나 맨 아래에 있을 수 있습니다 *tabLocation*합니다. 중 하나를 지정할 수 있습니다 `CMFCTabCtrl::LOCATION_BOTTOM` (기본값) 또는 `CMFCTabCtrl::LOCATION_TOP`합니다.  
  
 하는 경우 *bTabCustomTooltips* 가 TRUE 인 AFX_WM_ON_GET_TAB_TOOLTIP 메시지를 주 프레임 창에 보내집니다. 코드는이 메시지를 처리 하 고 MDI 탭에 대 한 사용자 지정 도구 설명을 사용 하 여 프레임 워크를 제공 수 있습니다.  
...
##  <a name="enablemditabslastactiveactivation"></a>  CMDIFrameWndEx::EnableMDITabsLastActiveActivation  
 사용자가 현재 탭을 닫을 때 마지막으로 활성 탭을 열 수 있는지 여부를 지정 합니다.  
...
### <a name="parameters"></a>매개 변수  
*bLastActiveTab*<br/>
[in] TRUE 이면 마지막 활성 탭의 정품 인증을 사용 하도록 설정 합니다. FALSE 이면 마지막 활성 탭의 정품 인증을 사용 하지 않도록 설정 합니다.  
  
### <a name="remarks"></a>설명  
 두 가지 방법으로 활성 탭을 닫으면는 탭이 열립니다.  
  
-   다음 탭을 활성화 합니다.  
  
-   이전에 활성 탭을 활성화 합니다.  
  
 첫 번째 방법은 사용 하는 기본 구현 합니다.  
  
 사용 하 여 `EnableMDITabsLastActiveActivation` 탭 정품 인증의 두 번째 방법은 사용할 수 있도록 합니다. Windows MDI 자식 창을 엽니다 서를 에뮬레이션 합니다.  
...
### <a name="parameters"></a>매개 변수  
*bEnable*<br/>
[in] TRUE 이면 창 메뉴의 자동 처리를 사용할 수 있습니다. FALSE 이면 자동 처리를 사용할 수 있습니다.  
  
*uiCustomizeCmd*<br/>
[in] 명령 ID를 합니다 **사용자 지정** 메뉴 항목입니다. 이 메뉴 항목은 일반적으로 창의 목록 끝에 추가 됩니다.  
  
*strCustomizeLabel*<br/>
[in] 에 대해 표시할 텍스트를 **사용자 지정** 메뉴 항목 (지역화).  
  
*uiViewToolbarsMenuEntryID*<br/>
[in] 창 메뉴를 열고 도구 모음 메뉴 항목의 ID를 지정 합니다. 이 일반적으로 **도구 모음** 의 하위 메뉴의 **보기** 메뉴.  
  
*bContextMenuShowsToolbarsOnly*<br/>
[in] True 이면 창 메뉴 도구 모음 목록만을 표시 합니다. FALSE 이면 메뉴 도구 모음 및 도킹 막대의 목록을 표시 합니다.  
...
*bShowHelpButton*<br/>
[in] 표시할지 여부를 지정 된 **도움말** windows 관리 대화 상자에서 단추.  
  
*uiMenuTextResId*<br/>
[in] 항목의 텍스트 문자열을 포함 하는 문자열 리소스 식별자입니다.  
  
### <a name="remarks"></a>설명  
 이 메서드를 사용 하 여 MDI 자식 창 관리 대화 상자를 호출 하는 해당 명령 메뉴 항목을 삽입 합니다 ( [CMFCWindowsManagerDialog 클래스](../../mfc/reference/cmfcwindowsmanagerdialog-class.md)). 지정 된 메뉴에 새 항목이 삽입 되 *uiMenuId*합니다. 호출 `EnableWindowsDialog` WM_CREATE 메시지를 처리 하는 경우.  
...
### <a name="return-value"></a>반환 값  
 활성 팝업 메뉴가;에 대 한 포인터 없음 팝업 메뉴의 활성 상태 이면 NULL입니다.  
  
### <a name="remarks"></a>설명  
 에 대 한 포인터를 가져오려면이 함수를 사용 합니다 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md) 현재 표시 되는 개체입니다.  
...
### <a name="remarks"></a>설명  
 이 메서드가 반환 하 여 MDI 프레임 창을 로드 했을 때 지정 된 리소스 ID [CFrameWnd::LoadFrame](../../mfc/reference/cframewnd-class.md#loadframe)합니다.  
...
### <a name="return-value"></a>반환 값  
 에 대 한 참조를 [CObList 클래스](../../mfc/reference/coblist-class.md) 탭 창 목록을 포함 하는 개체입니다. 목록을 수정 하거나 저장 하지 마십시오.  
  
### <a name="remarks"></a>설명  
 탭 창의 목록에 액세스 하려면이 메서드를 사용 합니다. 변경 하거나 개별 탭 창 일부 매개 변수를 쿼리 하려는 경우 유용할 수 있습니다.  
...
##  <a name="getmditabscontextmenualloweditems"></a>  CMDIFrameWndEx::GetMDITabsContextMenuAllowedItems  
 MDI 탭 그룹 기능을 사용 하는 경우 어떤 작업은 유효한 결정 하는 플래그의 조합을 반환 합니다.  
...
### <a name="remarks"></a>설명  
 MDI 탭 그룹 기능을 사용 하는 경우 특정 창 탭에서 허용 하는 작업 하는 것이 알아야 합니다. 이 메서드는 현재 탭된 창의 레이아웃을 분석 하 고 수 있는 플래그의 조합 하는 데 빌드, 예를 들어, 바로 가기 메뉴를 반환 합니다.  
  
 탭된 창이 하나만 있는 경우 또는 모든 탭된 창을 세로로 맞춰 지 면 새 세로 탭 그룹을 만들 수 있습니다.  
  
 모든 탭된 창이 가로로 정렬 되어 때나 탭된 창이 하나만 있으면 새 가로 탭 그룹을 만들 수 있습니다.  
...
##  <a name="getmenubar"></a>  CMDIFrameWndEx::GetMenuBar  
 프레임 창에 연결 하는 메뉴 모음 개체에 대 한 포인터를 반환 합니다.  
...
##  <a name="getpane"></a>  CMDIFrameWndEx::GetPane  
 지정 된 컨트롤 ID를 가진 창에 대 한 포인터를 반환 합니다.  
...
### <a name="return-value"></a>반환 값  
 있는 경우 지정 된 컨트롤 ID를가지고 있는 창에 대 한 포인터입니다. 그렇지 않으면 NULL입니다.  
...
### <a name="return-value"></a>반환 값  
 에 대 한 참조를 [CObList 클래스](../../mfc/reference/coblist-class.md) 에 대 한 포인터의 컬렉션을 포함 하는 개체 `CPane`-분리 상태에 있는 개체를 파생 합니다.  
  
### <a name="remarks"></a>설명  
 `CMDIFrameWndEx` 분리 메뉴의 컬렉션을 유지 합니다. 이 목록에 대 한 참조를 검색 하려면이 메서드를 사용 합니다.  
...
### <a name="return-value"></a>반환 값  
 메서드를 성공적으로 등록 창에 FALSE를 창 고 도킹 관리자를 사용 하 여 이미 등록 된 경우 TRUE입니다.  
  
### <a name="remarks"></a>설명  
 이 메서드를 사용 하 여 지정 된 창을 도킹 관리자에 관한 *pControlBar*합니다. 도킹 관리자의 창 정렬 및 도킹 관리자의 내부 목록에서 위치에 따라이 창의 정렬 됩니다.  
...
##  <a name="ismditabbedgroup"></a>  CMDIFrameWndEx::IsMDITabbedGroup  
 MDI 탭 그룹 기능을 사용 되는지 여부를 지정 합니다.  
...
### <a name="return-value"></a>반환 값  
 MDI 탭 그룹 기능을 사용 하는 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.  
  
### <a name="remarks"></a>설명  
 일반 MDI 탭 또는 MDI 탭 그룹 기능 사용 되는지 여부를 확인 하려면 [CMDIFrameWndEx::AreMDITabs](#aremditabs)합니다.  
  
##  <a name="ismemberofmditabgroup"></a>  CMDIFrameWndEx::IsMemberOfMDITabGroup  
 Windows MDI 탭 그룹에 있는 목록에서 지정된 된 탭된 창 인지 확인 합니다.  
...
### <a name="return-value"></a>반환 값  
 지정된 된 탭된 창을 MDI 탭 그룹을 형성 하는 탭된 창 목록을 이면 TRUE입니다. 그렇지 않으면 FALSE입니다.  
...
### <a name="return-value"></a>반환 값  
 메뉴 모음 개체에 대 한 포인터입니다; NULL이 아닌 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.  
...
### <a name="parameters"></a>매개 변수  
*nIDResource*<br/>
[in] 프레임 창에 연결 된 공유 리소스의 ID입니다.  
  
*dwDefaultStyle*<br/>
[in] 프레임 창 스타일입니다.  
  
*pParentWnd*<br/>
[in] 프레임의 부모에 대 한 포인터입니다.  
  
*pContext*<br/>
[in] 에 대 한 포인터를 [CCreateContext 구조체](../../mfc/reference/ccreatecontext-structure.md)합니다. 이 매개 변수는 NULL 일 수 있습니다.  
...
### <a name="return-value"></a>반환 값  
 로드가 성공 하면 TRUE입니다. FALSE 이면 로드 되지 않았거나 로드할 데이터가 없습니다.  
  
### <a name="remarks"></a>설명  
 으로 로드 하거나 MDI 탭 및 그룹의 상태 및 열린된 문서의 목록을 저장 하려면 다음을 수행 합니다.  
  
-   호출 [CMDIFrameWndEx::SaveMDIState](#savemdistate) 주 프레임을 닫을 때  
  
-   호출 [cmdiframewndex:: Loadmdistate](#loadmdistate) 주 프레임이 만들어질 때. 이 호출에 대 한 권장 되는 위치에는 주 프레임은 처음으로 표시 되기 전에입니다. 추가 `CWinAppEx::EnableLoadWindowPlacement` `(FALSE);` 하기 전에 `pMainFrame->LoadFrame (IDR_MAINFRAME);.` 추가 `CBCGPWorkspace::ReloadWindowPlacement` `(pMainFrame);` 호출한 후 `LoadMDIState` 레지스트리에 저장 된 위치에 있는 주 프레임을 표시 합니다.  
  
-   재정의 `GetDocumentName` 에 `CMDIChildWndEx`-응용 프로그램 파일로 저장 되지 않은 문서를 표시 하는 경우 클래스를 파생 합니다. 문서 식별자로 반환된 된 문자열 레지스트리에 저장 됩니다. 기본 구현을 [CMDIChildWndEx::GetDocumentName](../../mfc/reference/cmdichildwndex-class.md#getdocumentname) 에서 가져온 값을 반환 [CDocument::GetPathName](../../mfc/reference/cdocument-class.md#getpathname)합니다.  
  
-   재정의 [CMDIFrameWndEx::CreateDocumentWindow](#createdocumentwindow) 레지스트리에서 로드 되는 경우 문서를 올바르게 만드는 합니다. 첫 번째 매개 변수 문자열인는 `GetDocumentName` 반환 합니다.  
...
##  <a name="mditabmovetonextgroup"></a>  CMDIFrameWndEx::MDITabMoveToNextGroup  
 다음 또는 이전 탭된 그룹에 현재 활성 탭된 창에서 활성 탭을 이동합니다.  
...
### <a name="parameters"></a>매개 변수  
*bVert*<br/>
[in] 새 그룹 맞춤을 지정합니다. TRUE 이면 새 그룹을 세로로 맞춥니다. False 인 경우, 새 그룹을 가로로 맞춥니다.  
  
### <a name="remarks"></a>설명  
 이 함수를 사용 하 여 새 창 (새 탭된 그룹)를 탭 하 고 첫 번째 탭에 추가 합니다.  
...
##  <a name="m_bcancovertcontrolbartomdichild"></a>  CMDIFrameWndEx::m_bCanCovertControlBarToMDIChild  
 MDI 자식 창에 도킹 창 변환할 수 있는지 여부를 지정 합니다.  
...
### <a name="remarks"></a>설명  
 MDI 자식 창에 도킹 컨트롤 막대를 변환할 수 있는지 여부를 나타냅니다. 사용자가 선택 하는 경우 프레임 워크 변환을 자동으로 처리이 플래그가 TRUE 인 경우는 **탭 문서** 명령입니다. 플래그는 보호 되 고 명시적으로이 옵션을 설정 해야이 설정 하거나 `m_bCanCovertControlBarToMDIChild` 의 생성자에는 `CMDIFrameWndEx`-파생 클래스에서 재정의 또는 `CanConvertControlBarToMDIChild`합니다.  
...
##  <a name="m_bdisablesetredraw"></a>  CMDIFrameWndEx::m_bDisableSetRedraw  
 MDI 자식 창에 대 한 다시 그리기 최적화를 사용할지 설정 합니다.  
...
### <a name="remarks"></a>설명  
 ...
 MDI 자식 폼의 다시 그리기 최적화 하려는 경우이 플래그를 FALSE로 설정 합니다. 이 경우 호출 됩니다 `SetRedraw (FALSE)` 응용 프로그램에는 활성 탭 변경 될 때 주 프레임에 대 한 합니다.  
  
 이 플래그는 원치 않는 부작용 (예: 표시 되는 백그라운드 응용 프로그램)를 일으킬 수 있습니다. 따라서 눈에 띄는 깜박임 MDI 탭 활성화 하는 동안 발생 하는 경우에 기본값을 변경 하는 것이 좋습니다.  
  
##  <a name="negotiateborderspace"></a>  CMDIFrameWndEx::NegotiateBorderSpace  
 OLE 내부 활성화 동안 프레임 창의 테두리 공간을 협상합니다.  
...
### <a name="parameters"></a>매개 변수  
*nBorderCmd*<br/>
[in] 열거형에서 다음 값 중 하나가 포함 되어 있습니다 `CFrameWnd::BorderCmd`:  
...
### <a name="parameters"></a>매개 변수  
*pWnd*<br/>
[in] 닫히기 창에 대 한 포인터입니다.  
  
### <a name="return-value"></a>반환 값  
 도킹 창을 닫을 수 있는 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.  
  
### <a name="remarks"></a>설명  
 도킹 창 숨기기를 처리 하려면이 메서드를 재정의 합니다. 도킹 창을 숨길 하지 못하도록 하려는 경우 FALSE를 반환 합니다.  
...
### <a name="parameters"></a>매개 변수  
*pWnd*<br/>
[in] 닫히기 미니 프레임 창에 대 한 포인터입니다.  
  
### <a name="return-value"></a>반환 값  
 TRUE 이면 부동 미니 프레임 창을 닫을 수 있습니다. 그렇지 않으면 FALSE입니다.  
  
### <a name="remarks"></a>설명  
 부동 미니 프레임 창 숨기기를 처리 하려면이 메서드를 재정의 합니다. 숨겨진에서 부동 미니 프레임 창을 방지 하려는 경우 FALSE를 반환 합니다.  
...
### <a name="remarks"></a>설명  
 알림을 처리 하려는 경우이 메서드를 재정의 [CMFCPopupMenu 클래스](../../mfc/reference/cmfcpopupmenu-class.md) 개체만 WM_DESTROY 메시지를 처리할 때 MDI 프레임 창에 속해 있는 개체입니다.  
  
##  <a name="oncmdmsg"></a>  CMDIFrameWndEx::OnCmdMsg  
 명령 사용자 인터페이스 개체 업데이트를 라우팅하고 명령 메시지를 디스패치하기 위해 프레임 워크에서 호출 됩니다.  
...
*nCode*<br/>
[in] 명령 알림 코드를 식별합니다. 참조 [CCmdTarget::OnCmdMsg](../../mfc/reference/ccmdtarget-class.md#oncmdmsg) 에 대 한 자세한 내용은 *nCode*합니다.  
  
*pExtra*<br/>
[in] 값에 따라 사용할 *nCode*합니다. 참조 [CCmdTarget::OnCmdMsg](../../mfc/reference/ccmdtarget-class.md#oncmdmsg) 에 대 한 자세한 내용은 *pExtra*합니다.  
  
*pHandlerInfo*<br/>
[out에서] 일반적으로이 매개 변수는 NULL 이어야 합니다. NULL이 아닌 경우 `OnCmdMsg` 채웁니다 합니다 `pTarget` 및 `pmf` 의 멤버는 *pHandlerInfo* 명령 디스패치 하는 대신 구조입니다.  
...
*pMenuButton*<br/>
[in] 메뉴 단추에 대 한 포인터입니다.  
  
*rectImage*<br/>
[in] 이미지의 경계 사각형입니다.  
  
### <a name="return-value"></a>반환 값  
 TRUE 이면 메서드는 이미지를 그립니다. 기본 구현은 FALSE를 반환합니다.  
  
### <a name="remarks"></a>설명  
 소유 하 고 메뉴 모음에 속해 있는 메뉴 항목에 대 한 이미지 렌더링을 사용자 지정 하려는 경우이 메서드를 재정의 합니다 `CMDIFrameWndEx`-파생 개체입니다. 기본 구현은 아무 작업도 수행하지 않습니다.  
  
##  <a name="ondrawmenulogo"></a>  CMDIFrameWndEx::OnDrawMenuLogo  
 프레임 워크에서 호출 하면를 [CMFCPopupMenu](../../mfc/reference/cmfcpopupmenu-class.md)WM_PAINT 메시지를 처리 합니다.  
...
### <a name="remarks"></a>설명  
 소유 하 고 메뉴 모음에 속하는 팝업 메뉴에 로고를 표시 하려면이 함수를 재정의 합니다 `CMDIFrameWndEx`-파생 개체입니다. 기본 구현은 아무 작업도 수행하지 않습니다.  
  
##  <a name="onerasemdiclientbackground"></a>  CMDIFrameWndEx::OnEraseMDIClientBackground  
 MDI 프레임 창은 WM_ERASEBKGND 메시지를 처리할 때 프레임 워크에서 호출 됩니다.  
...
### <a name="return-value"></a>반환 값  
 TRUE 이면 응용 프로그램 메시지를 처리 하 고 백그라운드를 지웁니다.  
...
##  <a name="onmenubuttontoolhittest"></a>  CMDIFrameWndEx::OnMenuButtonToolHitTest  
 프레임 워크에서 호출 하면를 [CMFCToolBarButton](../../mfc/reference/cmfctoolbarbutton-class.md)개체에서 WM_NCHITTEST 메시지를 처리 합니다.  
...
### <a name="return-value"></a>반환 값  
 응용 프로그램 가득 찬 경우 TRUE를 *pTI* 매개 변수입니다. 기본 구현은 FALSE를 반환합니다.  
...
### <a name="parameters"></a>매개 변수  
*bPreview*<br/>
[in] TRUE 이면 인쇄 미리 보기 모드를 설정 합니다. False 인 경우, 취소 미리 보기 모드로 합니다.  
  
*pState*<br/>
[in] 에 대 한 포인터를 `CPrintPreviewState` 구조입니다.  
...
##  <a name="onshowcustomizepane"></a>  CMDIFrameWndEx::OnShowCustomizePane  
 빠른 사용자 지정 창 활성화 될 때 프레임 워크에서 호출 합니다.  
...
*dwAllowedItems*<br/>
[in] 현재 탭에 대 한 허용 되는 작업을 나타내는 플래그의 비트 OR 조합 합니다.  
...
- BCGP_MDI_CAN_BE_DOCKED-탭된 문서 (탭 문서에 해당) 도킹 된 상태로 전환 합니다.  
  
*bTabDrop*<br/>
[in] 다른 탭된 그룹을 사용 하 여 탭을 끌어 결과로 메뉴를 표시 하려면 TRUE입니다. 현재 활성 탭의 바로 가기 메뉴로 메뉴를 표시 하려면 FALSE입니다.  
  
### <a name="return-value"></a>반환 값  
 이 메서드를 재정의 하는 [CBCGPMDIFrameWnd](../../mfc/reference/cmdiframewndex-class.md)-클래스를 파생 합니다.  
  
### <a name="remarks"></a>설명  
 처리 되지 않으면 `OnShowMDITabContextMenu`, 바로 가기 메뉴에 표시 되지 것입니다. 이 함수에서 생성 되는 **MFC 응용 프로그램 마법사** MDI 탭 그룹 기능을 사용 하도록 설정 합니다.  
...
### <a name="parameters"></a>매개 변수  
*bShow*<br/>
[in] 창을 숨기려면 FALSE 창 표시 하려면 TRUE입니다.  
  
### <a name="return-value"></a>반환 값  
 창의 상태 창에서 지정한 상태 이미 있는 경우이 메서드를 FALSE 호출의 결과로 변경 되 면 TRUE *bShow*합니다. 예를 들어 숨겨진 창 및 *bShow* 가 FALSE를 반환 값은 FALSE입니다.  
  
### <a name="remarks"></a>설명  
 기본 구현에서는 최상위 프레임 창에서 도구 모음을 제거합니다.  
  
 하는 경우 [CDockingManager::m_bHideDockingBarsInContainerMode](../../mfc/reference/cdockingmanager-class.md#m_bhidedockingbarsincontainermode) 가 TRUE (기본값), 모든 도킹 창이 숨겨집니다.  
  
##  <a name="onshowpopupmenu"></a>  CMDIFrameWndEx::OnShowPopupMenu  
 팝업 메뉴가 열릴 때 프레임 워크에서 호출 됩니다.  
...
### <a name="return-value"></a>반환 값  
 팝업 메뉴 표시 되 면 TRUE입니다. 그렇지 않으면 FALSE입니다. 기본 구현에서는 TRUE를 반환합니다.  
  
### <a name="remarks"></a>설명  
 팝업 메뉴가 활성화 시 특수 한 처리를 구현 하려는 경우이 메서드를 재정의 합니다. 예를 들어 색 메뉴 단추에 일반 메뉴 항목을 변경 하려는 경우 분리 막대가 설정 등에입니다.  
  
 기본 구현은 아무 작업도 수행하지 않습니다.  
  
##  <a name="onsizemdiclient"></a>  CMDIFrameWndEx::OnSizeMDIClient  
 클라이언트 MDI 창 크기가 변경 될 때 프레임 워크에서 호출 됩니다.  
...
### <a name="return-value"></a>반환 값  
 활성화; 수 분리 모음으로 팝업 메뉴에는 TRUE 그렇지 않으면 FALSE입니다. 기본값은 TRUE입니다.  
  
### <a name="remarks"></a>설명  
 분리 막대가 막대에 대 한 특별 한 설정이 구현 하려는 경우이 함수를 재정의 합니다. 기본 구현은 아무 작업도 수행하지 않습니다.  
...
*nSensitivity*<br/>
[in] 각 선택 창의 창 사각형을 모든 방향으로이 값으로 확대 됩니다.  
  
*bExactBar*<br/>
[in] TRUE 이면 합니다 *nSensitivity* 매개 변수가 무시 됩니다.  
  
*pRTCBarType*<br/>
[in] Null이 아닌 메서드는 지정 된 형식의 창만를 반복 합니다.  
  
*dwAlignment*<br/>
[out] 창을 발견 되 면이 매개 변수는 창의 어느 쪽에 가장 가까운 지정 된 위치를 지정 합니다.  
  
### <a name="return-value"></a>반환 값  
 도킹 창 또는 컨트롤이 통해 지정한 점을 포함 하는 경우에 NULL에 대 한 포인터 *지점*합니다.  
  
### <a name="remarks"></a>설명  
 호출의 리디렉션 합니다 [CDockingManager 클래스](../../mfc/reference/cdockingmanager-class.md)합니다. 참조 [CDockingManager::ControlBarFromPoint](../../mfc/reference/cdockingmanager-class.md#panefrompoint) 자세한 내용은 합니다.  
...
### <a name="parameters"></a>매개 변수  
*bNotify*<br/>
[in] 프레임 창에 대 한 활성 전체 항목의 레이아웃 변경의 알림을 받을지 여부를 결정 합니다. True 이면 항목이 알려집니다. 그렇지 않으면 FALSE입니다.  
...
*bDestroy*<br/>
[in] 제거 창을 삭제 하려면 TRUE입니다. False 이면 삭제 되지 않습니다.  
  
*bAdjustLayout*<br/>
[in] True 이면 즉시 도킹 레이아웃을 조정 합니다. FALSE 인 경우 조정만 다시 그리기 이벤트가 발생할 때 다른 이유로 발생 합니다 (사용자의 창 크기를 조정, 등을 주 프레임 끌).  
  
*bAutoHide*<br/>
[in] 창 자동 숨기기 창 목록에서 제거 하려면 TRUE입니다. 창에 일반 창의 목록에서 제거 하려면 FALSE입니다.  
  
*pBarReplacement*<br/>
[in] 제거 창을 대체 하는 창에 대 한 포인터입니다.  
  
### <a name="remarks"></a>설명  
 각 창 도킹 레이아웃에 참여 하 고 도킹 관리자를 사용 하 여 등록 해야 합니다. 사용 하 여 [CMDIFrameWndEx::AddPane](#addpane) 하거나 [CMDIFrameWndEx::InsertPane](#insertpane) 창을 등록 합니다.  
  
 창 프레임 창의 도킹 레이아웃의 일부인 더 이상 하는 경우이 메서드를 사용 합니다.  
  
##  <a name="savemdistate"></a>  CMDIFrameWndEx::SaveMDIState  
 MDI 탭 그룹의 현재 레이아웃 및 이전에 열린된 문서의 목록을 저장합니다.  
...
### <a name="return-value"></a>반환 값  
 저장 성공 하면 TRUE입니다. FALSE 이면 저장 하지 못했습니다.  
...
-   호출 [cmdiframewndex:: Loadmdistate](#loadmdistate) 주 프레임이 만들어질 때. 이 호출에 대 한 권장 되는 위치에는 주 프레임은 처음으로 표시 되기 전에입니다.  
  
-   호출 `CWinAppEx::EnableLoadWindowPlacement(FALSE);` 하기 전에 `pMainFrame->LoadFrame (IDR_MAINFRAME);`  
  
-   호출 `CWinAppEx::ReloadWindowPlacement(pMainFrame)` 후 `LoadMDIState` 레지스트리에 저장 된 위치에 있는 주 프레임을 표시 합니다.  
  
-   재정의 `GetDocumentName` 에 `CMDIChildWndEx`-응용 프로그램 파일로 저장 되지 않은 문서를 표시 하는 경우 클래스를 파생 합니다. 문서 식별자로 반환된 된 문자열 레지스트리에 저장 됩니다. 자세한 내용은 [CMDIChildWndEx::GetDocumentName](../../mfc/reference/cmdichildwndex-class.md#getdocumentname)합니다.  
  
-   재정의 [CMDIFrameWndEx::CreateDocumentWindow](#createdocumentwindow) 레지스트리에서 로드 될 때 문서를 올바르게 만드는 합니다. 매개 변수를 `CreateDocumentWindow` 문자열인는 `GetDocumentName` 이전에 반환 합니다.  
...
##  <a name="setuptoolbarmenu"></a>  CMDIFrameWndEx::SetupToolbarMenu  
 사용자 정의 항목을 사용 하 여 더미 항목을 대체 하 여 도구 모음 개체를 수정 합니다.  
...
### <a name="parameters"></a>매개 변수  
*pBar*<br/>
[in] 표시 하거나 숨길 수를 창에 대 한 포인터입니다.  
  
*bShow*<br/>
[in] 창을 표시 하려면 TRUE입니다. 창을 숨기려면 FALSE입니다.  
  
*bDelay*<br/>
[in] 도킹 레이아웃의 다시 계산을 지연 하려면 TRUE입니다. 도킹 레이아웃을 즉시 다시 계산 하려면 FALSE입니다.  
  
*bActivate*<br/>
[in] Show true로 설정 하면 창에 활성으로 해야합니다. 비활성으로 창을 표시 하려면 FALSE입니다.  
  
### <a name="remarks"></a>설명  
 이 메서드는 창 표시 / 숨기기를 호출 합니다. 사용 하지 않는 `ShowWindow` 도킹 창에 대 한 합니다.  
...
### <a name="return-value"></a>반환 값  
 메서드가 성공, 실패 시 FALSE 되었으면 TRUE이 고  
...
### <a name="parameters"></a>매개 변수  
*dwData*<br/>
[in] 지정 된 도움말 유형에 대 한 필요에 따라 데이터를 지정 *nCmd*합니다.  
  
*nCmd*<br/>
[in] 요청한 도움말의 형식을 지정 합니다. 가능한 값 목록과 미치는 영향에 대 한 합니다 *dwData* 매개 변수를 참조 합니다 [WinHelp 함수](/windows/desktop/api/winuser/nf-winuser-winhelpa) Windows SDK의 합니다.  
