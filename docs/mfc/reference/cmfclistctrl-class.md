...
*bMark*<br/>
[in] 다른 배경색을 사용 하도록 설정 여부를 결정 하는 부울 매개 변수입니다.  
  
*bRedraw*<br/>
[in] 컨트롤을 즉시 다시 그리도록 여부를 결정 하는 부울 매개 변수입니다.  
...
### <a name="parameters"></a>매개 변수  
*bEnable*<br/>
[in] 여러 열 정렬 모드 사용 여부를 지정 하는 부울입니다.  
...
*dwData*<br/>
[in] 사용자 정의 데이터입니다. 기본 구현에서는이 매개 변수를 사용 하지 않습니다.  
