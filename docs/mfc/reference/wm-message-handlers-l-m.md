...
ms.locfileid: "50550464"
---
# <a name="wm-message-handlers-l---m"></a>WM_ 메시지 처리기: L - M
...
|ON_WM_MENUCHAR()|afx_msg 장기 [OnMenuChar](../../mfc/reference/cwnd-class.md#onmenuchar)(UINT, UINT, CMenu\*);|
