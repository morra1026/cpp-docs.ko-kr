...
### <a name="remarks"></a>설명  
 미니 프레임 창의 높이 확인 하려면이 메서드를 호출 합니다. 기본적으로 높이 SM_CYSMCAPTION에 설정 됩니다. 자세한 내용은 [GetSystemMetrics 함수](/windows/desktop/api/winuser/nf-winuser-getsystemmetrics)합니다.  
