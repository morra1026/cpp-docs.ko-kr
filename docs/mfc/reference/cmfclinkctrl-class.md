...
*bVCenter*<br/>
[in] 단추 텍스트 및 비트맵 위쪽과 아래쪽 링크 컨트롤 간에 세로로 가운데 TRUE 그렇지 않으면 FALSE입니다. 기본값은 FALSE입니다.

*bHCenter*<br/>
[in] 단추 텍스트 및 링크 컨트롤의 왼쪽과 오른쪽 간 가로 방향으로 비트맵 가운데 TRUE 그렇지 않으면 FALSE입니다. 기본값은 FALSE입니다.
