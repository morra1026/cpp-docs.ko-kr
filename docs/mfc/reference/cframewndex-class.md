...
Hdwp 구조에서 초기화 되는 [BeginDeferWindowPos](/windows/desktop/api/winuser/nf-winuser-begindeferwindowpos) 메서드.
...
*lpMMI*<br/>
[in] 에 대 한 포인터를 [MINMAXINFO](/windows/desktop/api/winuser/ns-winuser-tagminmaxinfo) 구조입니다.
