...
2.  호출 된 [CMFCCaptionBar::Create](#create) 캡션 표시줄 컨트롤을 만들고 연결 하는 메서드를 `CMFCCaptionBar` 개체입니다.  
  
3.  호출 [CMFCCaptionBar::SetButton](#setbutton)를 [CMFCCaptionBar::SetText](#settext)하십시오 [CMFCCaptionBar::SetIcon](#seticon), 및 [CMFCCaptionBar::SetBitmap](#setbitmap)캡션 표시줄 요소를 설정 합니다.  
