---
title: CMFCPropertyGridProperty 클래스 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|[CMFCPropertyGridProperty::AdjustButtonRect](#adjustbuttonrect)|속성에 포함 된 단추의 경계 사각형의 크기를 조정 하기가 부모 속성 목록 컨트롤에서 호출 됩니다.|
|[CMFCPropertyGridProperty::AdjustInPlaceEditRect](#adjustinplaceeditrect)|속성 값을 설정 하는 데 사용 되는 텍스트 상자 및 선택적 spin button 컨트롤의 경계를 검색 합니다.|
|[CMFCPropertyGridProperty::AllowEdit](#allowedit)|편집 가능 또는 읽기 전용 속성으로 설정 합니다.|
|[CMFCPropertyGridProperty::CreateInPlaceEdit](#createinplaceedit)|속성에 대 한 편집 가능한 컨트롤을 만들기 위해 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::CreateSpinControl](#createspincontrol)|편집 가능한 스핀 단추 컨트롤을 만들기 위해 프레임 워크에서 호출 됩니다.|
...
|[CMFCPropertyGridProperty::GetHierarchyLevel](#gethierarchylevel)|속성의 계층 구조 수준의 0부터 시작 인덱스를 검색합니다.|
|[CMFCPropertyGridProperty::GetName](#getname)|속성의 이름을 검색합니다.|
|[CMFCPropertyGridProperty::GetNameTooltip](#getnametooltip)|도구 설명에 속성의 이름을 표시 하기 위해 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::GetOption](#getoption)|인덱스로 지정 된 옵션의 텍스트를 검색 합니다.|
|[CMFCPropertyGridProperty::GetOptionCount](#getoptioncount)|속성에 속해 있는 옵션의 수를 검색 합니다.|
...
|[CMFCPropertyGridProperty::GetSubItem](#getsubitem)|0부터 시작 인덱스에 의해 식별 된 하위 속성을 검색 합니다.|
|[CMFCPropertyGridProperty::GetSubItemsCount](#getsubitemscount)|하위 항목의 수를 검색합니다.|
|`CMFCPropertyGridProperty::GetThisClass`|에 대 한 포인터를 가져오는 데 프레임 워크에 의해 합니다 [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) 이 클래스 형식과 연결 된 개체입니다.|
|[CMFCPropertyGridProperty::GetValue](#getvalue)|속성 값을 검색합니다.|
|[CMFCPropertyGridProperty::GetValueTooltip](#getvaluetooltip)|다음 도구 설명에 표시 되는 속성 값의 텍스트 표현을 검색 하기 위해 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::HitTest](#hittest)|지점에 해당 하는 속성 목록 항목에 해당 하는 속성 개체를 가리킵니다.|
...
|[CMFCPropertyGridProperty::IsExpanded](#isexpanded)|속성 확장 또는 축소 있는지 여부를 나타냅니다.|
|[CMFCPropertyGridProperty::IsGroup](#isgroup)|현재 속성 그룹을 나타내는지 여부를 나타냅니다.|
|[CMFCPropertyGridProperty::IsInPlaceEditing](#isinplaceediting)|현재 속성은 편집할 수 있는지 여부를 나타냅니다.|
...
|[CMFCPropertyGridProperty::OnDblClk](#ondblclk)|속성을 두 번 클릭할 때 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::OnDrawButton](#ondrawbutton)|속성에 포함 된 단추를 그리기 위해 프레임 워크에서 호출 됩니다.|
...
|[CMFCPropertyGridProperty::OnRClickName](#onrclickname)|속성 이름 영역에서 마우스 오른쪽 단추를 클릭할 때 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::OnRClickValue](#onrclickvalue)|속성 값 영역에서 마우스 오른쪽 단추를 클릭할 때 프레임 워크에서 호출 됩니다.|
...
|이름|설명|
|----------|-----------------|
|[CMFCPropertyGridProperty::CreateCombo](#createcombo)|속성 콤보 상자를 추가 하기 위해 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::HasButton](#hasbutton)|단추 속성에 포함 되는지 여부를 나타냅니다.|
|[CMFCPropertyGridProperty::Init](#init)|속성 개체를 초기화 하기 위해 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::IsSubItem](#issubitem)|지정된 된 속성에는 현재 속성의 하위 항목 인지 여부를 나타냅니다.|
|[CMFCPropertyGridProperty::IsValueChanged](#isvaluechanged)|현재 속성의 값이 변경 되었는지 여부를 나타냅니다.|
|[CMFCPropertyGridProperty::OnCtlColor](#onctlcolor)|속성의 배경색에 맞게 브러시를 검색 해야 하는 경우 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::OnDestroyWindow](#ondestroywindow)|속성을 소멸 될 때 또는 편집을 완료 하는 경우 프레임 워크에서 호출 됩니다.|
|[CMFCPropertyGridProperty::OnKillFocus](#onkillfocus)|속성은 입력된 포커스를 잃었을 때 프레임 워크에서 호출 됩니다.|
...
사용 하 여는 `CMFCPropertyGridProperty` 다음 속성 목록 컨트롤에 추가 하는 속성을 나타내는 개체입니다. 자세한 내용은 [CMFCPropertyGridCtrl 클래스](../../mfc/reference/cmfcpropertygridctrl-class.md)합니다.
...
부모 및 자식의 계층적 목록을 속성을 만들려면이 메서드를 사용 합니다. 자식 후 부모 속성에 더하기 (+)으로 지정 되는 확장 상자 컨트롤을 자동으로 표시 속성이 추가 됩니다. 사용자가 더하기 기호를 클릭 하면 부모 속성을 확장 하 고 모든 자식 속성 항목을 표시 합니다.

##  <a name="adjustbuttonrect"></a>  CMFCPropertyGridProperty::AdjustButtonRect

속성에 포함 된 단추의 경계 사각형의 크기를 조정 하기가 부모 속성 목록 컨트롤에서 호출 됩니다.
...
- 단추에 대 한 같음 단추의 높이의 너비와 3 픽셀로 조정합니다.

- 속성의 오른쪽 가장자리에 단추의 경계 사각형을 이동

- 속성의 위쪽 가장자리 아래로 단추 1 픽셀 만큼 이동합니다.

##  <a name="adjustinplaceeditrect"></a>  CMFCPropertyGridProperty::AdjustInPlaceEditRect

속성 값을 설정 하는 데 사용 되는 텍스트 상자 및 선택적 spin button 컨트롤의 경계를 검색 합니다.
...
속성 콤보 상자를 추가 하기 위해 프레임 워크에서 호출 됩니다.
...
속성에 대 한 편집 가능한 컨트롤을 만들기 위해 프레임 워크에서 호출 됩니다.
...
값을 사용 하는이 메서드는 *varValue*, *lpszEditMask*합니다 *lpszEditTemplate*, 및 *lpszValidChars* 매개 변수를 에 지정 된 [CMFCPropertyGridProperty](../../mfc/reference/cmfcpropertygridproperty-class.md) 클래스 생성자입니다. 기본적으로이 메서드는 지원 합니다 *varValue* variant 형식입니다. VT_BSTR, VT_R4, VT_R8, VT_UI1, VT_I2, VT_INT, VT_UINT, VT_I4, VT_UI2, VT_UI4, 및 VT_BOOL이 포함 됩니다.

이 메서드를 만듭니다는 [CMFCMaskedEdit](../../mfc/reference/cmfcmaskededit-class.md) 하나 이상의 컨트롤을 *lpszEditMask*를 *lpszEditTemplate*, 또는 *lpszValidChars* 매개 변수를 지정 합니다. 생성이 고, 그렇지는 [CEdit](../../mfc/reference/cedit-class.md) 제어 합니다.

##  <a name="createspincontrol"></a>  CMFCPropertyGridProperty::CreateSpinControl

편집 가능한 스핀 단추 컨트롤을 만들기 위해 프레임 워크에서 호출 됩니다.
...
사용 하거나 속성 값을 수정 하는 데 사용 되는 스핀 단추 컨트롤을 사용 하지 않도록 설정 합니다.
...
속성 형식으로 지정 되는 *varValue* 의 매개 변수를 [CMFCPropertyGridProperty::CMFCPropertyGridProperty](#cmfcpropertygridproperty) 생성자는 지원 되는 variant 형식 이어야 합니다. 그렇지 않은 경우이 메서드는 디버그 모드에서 어설션합니다. 지원 되는 형식에는 VT_INT, VT_UINT, VT_I2, VT_I4, VT_UI2, 및 VT_UI4 포함 됩니다.

##  <a name="expand"></a>  CMFCPropertyGridProperty::Expand

확장 하거나 축소 하는 하위 속성을 포함 하는 속성입니다.
...
이 메서드는 속성 값을 표시 되기 전에 프레임 워크에서 호출 됩니다.

##  <a name="getdata"></a>  CMFCPropertyGridProperty::GetData

속성을 사용 하 여 연결 된 DWORD 값을 검색 합니다.
...
반환 되는 데이터는 숫자 또는 기타 데이터에 대 한 포인터 등의 응용 프로그램 특정 값으로. 속성을 생성 하는 경우 또는 호출 하는 경우 데이터 값을 지정 합니다 [CMFCPropertyGridProperty::SetData](#setdata) 메서드.
...
속성의 계층 구조 수준의 0부터 시작 인덱스를 검색합니다.
...
도구 설명에 속성의 이름을 표시 하기 위해 프레임 워크에서 호출 됩니다.
...
*nIndex*<br/>
(옵션)를 검색 하는 속성 목록 항목의 0부터 시작 하는 인덱스입니다.
...
호출 된 [CMFCPropertyGridProperty::AddOption](#addoption) 속성 목록에 항목을 추가 하는 방법입니다. 호출 된 [CMFCPropertyGridProperty::RemoveAllOptions](#removealloptions) 모든 항목을 제거 하는 방법입니다.
...
현재 속성의 값을 변경 하는 편집 작업의 효과 취소 하려면이 메서드를 사용 합니다.

현재 속성의 원래 값 설정 됩니다는 [CMFCPropertyGridProperty::CMFCPropertyGridProperty](#cmfcpropertygridproperty) 생성자에 의해 수정 된 [CMFCPropertyGridProperty::SetOriginalValue](#setoriginalvalue) 메서드 를 하 여 다시 설정 합니다 [cmfcpropertygridproperty:: Resetoriginalvalue](#resetoriginalvalue) 메서드.
...
최상위 속성에 대 한 부모 속성 개체 또는 NULL 포인터입니다.
...
A [CRect](../../atl-mfc-shared/reference/crect-class.md) 경계 사각형을 나타내는 개체입니다.

### <a name="remarks"></a>설명

##  <a name="getsubitem"></a>  CMFCPropertyGridProperty::GetSubItem

0부터 시작 인덱스에 의해 식별 된 하위 속성을 검색 합니다.
...
소매 모드의 경우 NULL을 *nIndex* 매개 변수가 올바르지 않습니다. 디버그 모드에서이 메서드 어설션합니다.
...
다음 도구 설명에 표시 되는 속성 값의 텍스트 표현을 검색 하기 위해 프레임 워크에서 호출 됩니다.
...
TRUE 이면 속성 단추 (또는 속성 목록);이 포함 그렇지 않으면 FALSE입니다.
...
기본적으로이 메서드 내에서 속성 항목의 지정된 된 지점이 없는 경우 속성의 하위 항목을 테스트 합니다.

다음 표에서에 반환 될 수 있는 값을 *pnArea* 매개 변수입니다.
...
속성 개체를 초기화 하기 위해 프레임 워크에서 호출 됩니다.
...
TRUE 이면 속성이 편집할 수 있습니다. 그렇지 않으면 FALSE입니다.
...
속성을 사용 하면 TRUE입니다. 속성은 사용 하지 않도록 설정 하는 경우에 FALSE입니다.
...
TRUE 이면 속성이 확장 됩니다. 속성은 축소 되어 있으면 FALSE입니다.
...
현재 속성 개체는 그룹을 나타내면 TRUE 속성 값을 나타내는 경우 FALSE입니다.
...
TRUE 이면 현재 속성은 편집할 수 있습니다. 그렇지 않으면 FALSE입니다.
...
속성을 수정 하는 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.
...
TRUE 이면 현재 속성의 모든 부모를 확장 합니다. FALSE 이면 부모 속성 축소 됩니다.
...
현재 속성을 선택 하는 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.

### <a name="remarks"></a>설명

##  <a name="issubitem"></a>  CMFCPropertyGridProperty::IsSubItem

지정된 된 속성에는 현재 속성의 하위 항목 인지 여부를 나타냅니다.
...
현재 속성의 값이 변경 됩니다. 그렇지 않으면 FALSE입니다.
...
부동 소수점 형식의 값에 대 한 형식 문자열을 포함합니다.
...
속성의 이름 필드를 클릭할 때 부모 속성 목록 컨트롤에서 호출 됩니다.
...
속성의 값 필드를 클릭할 때 부모 속성 목록 컨트롤에서 호출 됩니다.
...
기본적으로이 메서드는 현재 속성을 편집할 수 없는 경우 FALSE를 반환 합니다. 편집 이나이 속성을 사용 하 여 연결 된 spin 컨트롤에 지정 된 마우스 메시지를 처리 하 고이 메서드가 TRUE를 반환 하는 다음이 고, 그렇지 합니다.

##  <a name="onclosecombo"></a>  CMFCPropertyGridProperty::OnCloseCombo

속성에 포함 된 콤보 상자를 닫을 때 프레임 워크에서 호출 됩니다.
...
속성의 배경색에 맞게 브러시를 검색 해야 하는 경우 프레임 워크에서 호출 됩니다.
...
속성을 소멸 될 때 또는 편집을 완료 하는 경우 프레임 워크에서 호출 됩니다.
...
속성에 포함 된 단추를 그리기 위해 프레임 워크에서 호출 됩니다.
...
하위 속성을 포함 하는 속성 거의 확장 상자 컨트롤을 그리기 위해 프레임 워크에서 호출 됩니다.
...
속성 이름을 표시 하기 위해 프레임 워크에서 호출 됩니다.
...
이 함수는 사용자 속성 값을 수정 하려고 할 때 프레임 워크에서 호출 됩니다. 기본적으로이 메서드는 콤보 상자 컨트롤 또는 스핀 컨트롤에 대 한 적절 한 편집기를 시작합니다.
...
기본적으로이 메서드는 현재 편집 컨트롤을 제거 하 고 TRUE를 반환 합니다.

##  <a name="onkillfocus"></a>  CMFCPropertyGridProperty::OnKillFocus

속성은 입력된 포커스를 잃었을 때 프레임 워크에서 호출 됩니다.
...
기본적으로이 메서드는 아무 작업도 수행 하지 하 고 TRUE를 반환 합니다. 이 메서드를 재정의 하는 경우 프레임 워크 속성 입력된 포커스를 잃으면 편집 작업을 종료할 수 있습니다 하는 경우 TRUE를 반환 합니다.
...
속성 이름 영역에서 마우스 오른쪽 단추를 클릭할 때 프레임 워크에서 호출 됩니다.
...
속성 값 영역에서 마우스 오른쪽 단추를 클릭할 때 프레임 워크에서 호출 됩니다.
...
사용자가 편집할 수 있는 콤보 상자에서 항목을 선택할 때 프레임 워크에서 호출 됩니다.
...
속성 항목에 마우스 포인터를 움직이면 프레임 워크에서 호출 됩니다.
...
현재 속성은 variant 형식 또는 값의 목록 및이 메서드는 삽입 지점 (i-빔) 마우스 커서를 성공적으로 로드 하는 경우 TRUE입니다. 그렇지 않으면 FALSE입니다.
...
속성을 선택 하 고 사용자가 새 문자를 입력할 때 속성 목록 컨트롤에서 호출 됩니다.
