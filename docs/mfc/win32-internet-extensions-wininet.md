...
- [인터넷 클라이언트 애플리케이션을 만들기 위한 MFC 클래스](../mfc/mfc-classes-for-creating-internet-client-applications.md)
...
- [일반적인 인터넷 클라이언트 애플리케이션의 단계](../mfc/steps-in-a-typical-internet-client-application.md)

- [일반적인 FTP 클라이언트 애플리케이션의 단계](../mfc/steps-in-a-typical-ftp-client-application.md)

- [일반적인 FTP 클라이언트 애플리케이션에서 파일을 삭제하는 단계](../mfc/steps-in-a-typical-ftp-client-application-to-delete-a-file.md)

- [일반적인 Gopher 클라이언트 애플리케이션의 단계](../mfc/steps-in-a-typical-gopher-client-application.md)

- [일반적인 HTTP 클라이언트 애플리케이션의 단계](../mfc/steps-in-a-typical-http-client-application.md)
