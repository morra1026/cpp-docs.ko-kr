---
title: Crebar와 CReBarCtrl | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "46442853"
---
# <a name="crebar-vs-crebarctrl"></a>Crebar와 CReBarCtrl

Rebars 만들려는 두 클래스를 제공 하는 MFC: [CReBar](../mfc/reference/crebar-class.md) 하 고 [CReBarCtrl](../mfc/reference/crebarctrl-class.md) (하는 Windows 공용 컨트롤 API를 래핑하여). `CReBar` rebar 공용 컨트롤의 기능을 모두 제공 수에 대 한 다양 한 일반적인 필수 컨트롤 설정 및 구조를 처리 합니다.
